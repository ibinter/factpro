...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $methods = [
            ['type' => 'mobile_money', 'country' => 'CI', 'label' => 'Orange Money Côte d\'Ivoire', 'operator' => 'orange', 'account_number' => '+225 07 78 88 25 92', 'account_holder' => 'IBIG SARL', 'currency' => 'XOF', 'instructions' => 'Envoyez le montant exact puis conservez le SMS de confirmation comme preuve.', 'sort_order' => 1],
            ['type' => 'mobile_money', 'country' => 'CI', 'label' => 'Wave Côte d\'Ivoire', 'operator' => 'wave', 'account_number' => '+225 07 78 88 25 92', 'account_holder' => 'IBIG SARL', 'currency' => 'XOF', 'instructions' => 'Transfert Wave sans frais. Faites une capture d\'écran du reçu.', 'sort_order' => 2],
            ['type' => 'mobile_money', 'country' => 'CI', 'label' => 'MTN Mobile Money CI', 'operator' => 'mtn', 'account_number' => '+225 05 55 05 99 01', 'account_holder' => 'IBIG SARL', 'currency' => 'XOF', 'instructions' => 'Envoyez via MoMo puis notez la référence de transaction.', 'sort_order' => 3],
            ['type' => 'mobile_money', 'country' => 'CI', 'label' => 'Moov Money Côte d\'Ivoire', 'operator' => 'moov', 'account_number' => '+225 01 53 59 55 44', 'account_holder' => 'IBIG SARL', 'currency' => 'XOF', 'instructions' => 'Envoyez via Moov Money puis conservez le reçu de transaction.', 'sort_order' => 4],
            ['type' => 'bank_national', 'country' => 'CI', 'label' => 'Banque Atlantique CI', 'operator' => null, 'bank_name' => 'Banque Atlantique', 'account_number' => 'CI93 CI042 01001 123456789012 34', 'account_holder' => 'IBIG SARL', 'currency' => 'XOF', 'instructions' => 'Mentionnez votre numéro de commande en référence du virement.', 'sort_order' => 5],
        ];

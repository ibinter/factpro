    ...
    <nav class="sticky top-0 z-40 border-b border-gray-100 bg-white/90 backdrop-blur">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            ...
            <div class="hidden items-center gap-8 md:flex">
                ...
                <a href="/changelog" class="text-sm font-semibold text-gray-600 hover:text-brand-600">Nouveautés</a>
        ...
        <div v-show="open" class="border-t border-gray-100 bg-white px-6 py-4 md:hidden">
            <div class="flex flex-col gap-3">
                ...
                <a href="/changelog" class="text-sm font-semibold text-gray-700" @click="open = false">Nouveautés</a>

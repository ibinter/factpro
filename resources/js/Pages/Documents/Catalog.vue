...
const CATS = [
  { id: 'vente', label: 'Vente & Facturation', icon: '💰', color: '#2563EB', docs: [
    ...
    { id: 'bon_gar', factproType: 'service_report', name: "Bon de Garantie", icon: '🛡️', desc: "Document attestant la garantie produit accordée client", pop: false },
    ...
    { id: 'recu_partiel', factproType: 'receipt', name: "Reçu Partiel", icon: '🧾', desc: "Reçu confirmant paiement partiel d'une facture", pop: false },
    ...
    { id: 'cert_prise', factproType: 'service_report', name: "Cert. Prise en Charge", icon: '📝', desc: "Certificat officiel de prise en charge d'un dossier client", pop: false },
  ]},
  { id: 'achat', label: 'Achats & Fournisseurs', icon: '🏪', color: '#7C3AED', docs: [
    ...
    { id: 'grille_eval_f', factproType: 'service_report', name: "Grille Évaluation F.", icon: '📊', desc: "Critères de sélection et notation des fournisseurs", pop: false },
    { id: 'contrat_cadre', factproType: 'supplier_order', name: "Contrat Cadre Achat", icon: '📜', desc: "Accord général encadrant les commandes récurrentes", pop: true },
    { id: 'avenant_cmd', factproType: 'supplier_order', name: "Avenant Commande", icon: '✏️', desc: "Modification contractuelle d'une commande existante", pop: false },
    ...
    { id: 'fiche_homolog', factproType: 'service_report', name: "Fiche Homologation", icon: '🏷️', desc: "Validation officielle d'un nouveau fournisseur référencé", pop: false },
    { id: 'rapport_qual_r', factproType: 'service_report', name: "Rapport Qualité Récep.", icon: '🔍', desc: "Contrôle qualité des marchandises à la réception", pop: false },
    ...
    { id: 'dem_garantie', factproType: 'service_report', name: "Demande de Garantie", icon: '🛡️', desc: "Réclamation de garantie auprès d'un fournisseur", pop: false },
    { id: 'contrat_soustr', factproType: 'supplier_order', name: "Contrat Sous-Traitance", icon: '🤝', desc: "Délégation partielle de prestation à un sous-traitant", pop: true },
    ...
    { id: 'attest_conf_f', factproType: 'service_report', name: "Attestation Conformité", icon: '🎖️', desc: "Certification de conformité produit par le fournisseur", pop: false },
    { id: 'ordre_rappel', factproType: 'supplier_order', name: "Ordre de Rappel", icon: '🔔', desc: "Instruction de retrait de produit non conforme", pop: false },
  ...
  { id: 'stock', label: 'Stocks & Inventaire', icon: '📦', color: '#D97706', docs: [
    ...
    { id: 'rapport_peremp', factproType: 'service_report', name: "Rapport Péremption", icon: '⏰', desc: "Suivi des articles proches de péremption", pop: false },
    { id: 'bilan_stock', factproType: 'service_report', name: "Bilan de Stock", icon: '📊', desc: "Synthèse globale des niveaux de stock", pop: true },
    { id: 'pv_casse', factproType: 'service_report', name: "PV de Casse", icon: '💥', desc: "Procès-verbal officiel de destruction marchandise", pop: false },
    ...
    { id: 'alerte_reap', factproType: 'service_report', name: "Alerte Réapprovisionnement", icon: '🔔', desc: "Notification de seuil minimum stock atteint", pop: true },
    { id: 'rapport_rotat', factproType: 'service_report', name: "Rapport de Rotation", icon: '📈', desc: "Analyse de la rotation des articles stock", pop: false },
    ...
    { id: 'plan_entrepot', factproType: 'service_report', name: "Plan Entrepôt", icon: '🗺️', desc: "Cartographie et plan de rangement entrepôt", pop: false },
  ]},
  { id: 'sav', label: 'SAV & Maintenance', icon: '🔧', color: '#0891B2', docs: [
    ...
    { id: 'fiche_diagno', factproType: 'service_report', name: "Fiche Diagnostic", icon: '🔍', desc: "Diagnostic technique d'un équipement défaillant", pop: true },
    { id: 'rapport_expert', factproType: 'service_report', name: "Rapport Expertise", icon: '🧪', desc: "Expertise technique détaillée d'un équipement", pop: false },
    { id: 'cert_remise', factproType: 'receipt', name: "Cert. Remise en État", icon: '✅', desc: "Certificat attestant la remise en état produit", pop: false },
    { id: 'plan_maint_p', factproType: 'service_report', name: "Planning Maintenance", icon: '📅', desc: "Calendrier de maintenance préventive planifiée", pop: true },
    { id: 'contrat_supp', factproType: 'service_report', name: "Contrat de Support", icon: '🤝', desc: "Contrat de support technique et assistance client", pop: true },
    { id: 'ticket_inc', factproType: 'service_report', name: "Ticket Incident", icon: '🎫', desc: "Enregistrement et suivi d'un incident client", pop: true },
    ...
    { id: 'fiche_tech_p', factproType: 'service_report', name: "Fiche Technique Produit", icon: '📄', desc: "Spécifications techniques complètes d'un produit", pop: false },
    { id: 'notice_util', factproType: 'service_report', name: "Notice Utilisation", icon: '📖', desc: "Guide d'utilisation destiné à l'utilisateur final", pop: false },
    { id: 'rapport_test', factproType: 'service_report', name: "Rapport de Test", icon: '🧾', desc: "Résultats des tests effectués sur un équipement", pop: false },
    { id: 'bon_pret', factproType: 'delivery_note', name: "Bon de Prêt", icon: '🔁', desc: "Bon de prêt temporaire d'équipement au client", pop: false },
    { id: 'attest_conf', factproType: 'receipt', name: "Attest. Conformité", icon: '🏅', desc: "Attestation de mise en conformité réglementaire produit", pop: false },
  ]},
  { id: 'btp', label: 'BTP & Travaux', icon: '🏗️', color: '#DC2626', docs: [
    ...
    { id: 'cctp', factproType: 'service_report', name: "CCTP", icon: '📋', desc: "Cahier des clauses techniques et prescriptions", pop: true },
    ...
    { id: 'mem_tech', factproType: 'service_report', name: "Mémoire Technique", icon: '🗂️', desc: "Document technique justificatif de l offre", pop: false },
    { id: 'plan_charge', factproType: 'service_report', name: "Plan de Charge", icon: '📅', desc: "Répartition des ressources sur le chantier", pop: false },
    { id: 'fiche_pose', factproType: 'service_report', name: "Fiche de Pose", icon: '🔧', desc: "Suivi installation d un équipement posé", pop: false },
    { id: 'rap_secu_ch', factproType: 'service_report', name: "Rapport Sécurité", icon: '⛑️', desc: "Rapport de sécurité hebdomadaire du chantier", pop: false },
    { id: 'cert_conf_tr', factproType: 'receipt', name: "Cert. Conformité", icon: '✅', desc: "Certificat de conformité des travaux réalisés", pop: false },
    ...
    { id: 'gantt_ch', factproType: 'service_report', name: "Planning Gantt", icon: '📆', desc: "Planning prévisionnel Gantt du chantier", pop: false },
    { id: 'journal_ch', factproType: 'service_report', name: "Journal de Chantier", icon: '📓', desc: "Registre journalier des activités du chantier", pop: true },
    { id: 'fiche_nc', factproType: 'service_report', name: "Fiche Non-Conformité", icon: '🚫', desc: "Signalement et suivi d une non-conformité chantier", pop: false },
    { id: 'bon_regie', factproType: 'invoice', name: "Bon de Régie", icon: '🧾', desc: "Facturation de travaux en régie journalière", pop: false },
    { id: 'cert_achev', factproType: 'receipt', name: "Cert. Achèvement", icon: '🏅', desc: "Certificat d achèvement des travaux contractuels", pop: true },
    { id: 'attest_fin_tr', factproType: 'receipt', name: "Attest. Fin Travaux", icon: '🎖️', desc: "Attestation officielle de fin de travaux", pop: false },
  ]},
  { id: 'logistique', label: 'Logistique & Transport', icon: '🚛', color: '#059669', docs: [
    ...
    { id: 'rap_transport', factproType: 'service_report', name: "Rapport Transport", icon: '📋', desc: "Compte rendu d une opération de transport", pop: false },
    ...
    { id: 'planning_liv', factproType: 'service_report', name: "Planning Livraisons", icon: '🗓️', desc: "Calendrier prévisionnel des livraisons planifiées", pop: false },
    { id: 'fiche_vehic', factproType: 'service_report', name: "Fiche Véhicule", icon: '🚛', desc: "Fiche d entretien et suivi du véhicule", pop: false },
    { id: 'rap_accident', factproType: 'service_report', name: "Rapport Accident", icon: '⚠️', desc: "Déclaration d accident survenu lors du transport", pop: false },
    { id: 'attest_liv', factproType: 'receipt', name: "Attest. Livraison", icon: '✔️', desc: "Attestation confirmant la livraison effectuée", pop: false },
  ...
  { id: 'finance', label: 'Finance & Trésorerie', icon: '💳', color: '#0284C7', docs: [
    ...
    { id: 'recu_virement', factproType: 'receipt', name: "Reçu de virement", icon: '✅', desc: "Confirmation de réception d un virement bancaire", pop: false },
    ...
    { id: 'attest_solde', factproType: 'receipt', name: "Attestation de solde", icon: '🏅', desc: "Certificat officiel du solde d un compte", pop: false },
    ...
    { id: 'dem_credit_int', factproType: 'advance_invoice', name: "Demande crédit interne", icon: '🤝', desc: "Demande de financement interne à l entreprise", pop: false },
    { id: 'lettre_mise_p', factproType: 'service_report', name: "Lettre mise à pied", icon: '⛔', desc: "Notification de suspension temporaire du salarié", pop: false },
    { id: 'pv_discipline', factproType: 'service_report', name: "PV conseil discipline", icon: '⚖️', desc: "Procès-verbal de la séance disciplinaire tenue", pop: false },
    { id: 'fiche_accident', factproType: 'service_report', name: "Fiche accident travail", icon: '🚑', desc: "Déclaration d un accident survenu au travail", pop: false },
    { id: 'avenant_contrat', factproType: 'service_report', name: "Avenant contrat", icon: '✏️', desc: "Modification officielle d une clause du contrat", pop: false },
    { id: 'rapport_fin_st', factproType: 'service_report', name: "Rapport fin de stage", icon: '📝', desc: "Bilan écrit remis à la fin du stage effectué", pop: false },
    { id: 'lettre_recomm', factproType: 'service_report', name: "Lettre de recommandation", icon: '⭐', desc: "Témoignage positif officiel sur un ancien collaborateur", pop: false },
  ]},
  { id: 'rh', label: 'Ressources Humaines', icon: '👥', color: '#7C3AED', docs: [
    ...
    { id: 'contrat_cdi', factproType: 'service_report', name: "Contrat CDI", icon: '📃', desc: "Contrat de travail à durée indéterminée", pop: true },
    { id: 'contrat_cdd', factproType: 'service_report', name: "Contrat CDD", icon: '📄', desc: "Contrat de travail à durée déterminée", pop: true },
    { id: 'contrat_stage', factproType: 'service_report', name: "Contrat de stage", icon: '🎓', desc: "Convention de stage entre stagiaire et entreprise", pop: true },
    { id: 'contrat_partiel', factproType: 'service_report', name: "Contrat temps partiel", icon: '⏱️', desc: "Contrat de travail à temps partiel signé", pop: false },
    { id: 'lettre_embauche', factproType: 'service_report', name: "Lettre d embauche", icon: '✉️', desc: "Offre officielle d emploi adressée au candidat", pop: true },
    { id: 'lettre_licenc', factproType: 'service_report', name: "Lettre de licenciement", icon: '📮', desc: "Notification formelle de rupture du contrat", pop: false },
    { id: 'lettre_demiss', factproType: 'service_report', name: "Lettre de démission", icon: '🚪', desc: "Déclaration de départ volontaire du salarié", pop: false },
    { id: 'solde_tt_cpt', factproType: 'receipt', name: "Solde de tout compte", icon: '🔏', desc: "Reçu final de toutes sommes dues au salarié", pop: true },
    { id: 'attest_travail', factproType: 'service_report', name: "Attestation de travail", icon: '🗒️', desc: "Justificatif officiel d emploi en cours ou passé", pop: true },
    { id: 'attest_salaire', factproType: 'service_report', name: "Attestation de salaire", icon: '💼', desc: "Preuve de la rémunération perçue par le salarié", pop: true },
    { id: 'cert_travail', factproType: 'service_report', name: "Certificat de travail", icon: '🏆', desc: "Document remis à la fin du contrat de travail", pop: false },
    { id: 'fiche_poste', factproType: 'service_report', name: "Fiche de poste", icon: '📌', desc: "Description détaillée des missions et responsabilités", pop: false },
    { id: 'grille_sal', factproType: 'payslip', name: "Grille salariale", icon: '💹', desc: "Barème des salaires par catégorie et échelon", pop: false },
    { id: 'planning_conges', factproType: 'service_report', name: "Planning congés", icon: '🏖️', desc: "Calendrier annuel des absences autorisées planifiées", pop: true },
    { id: 'fiche_presence', factproType: 'service_report', name: "Fiche de présence", icon: '🕐', desc: "Relevé quotidien des heures de présence salariée", pop: true },
    { id: 'rapport_eval', factproType: 'service_report', name: "Rapport d évaluation", icon: '📊', desc: "Appréciation annuelle des performances du salarié", pop: false },
    { id: 'lettre_avert', factproType: 'service_report', name: "Lettre d avertissement", icon: '🔔', desc: "Sanction écrite pour manquement aux obligations professionnelles", pop: false },
    { id: 'accord_conf_rh', factproType: 'service_report', name: "Accord confidentialité RH", icon: '🔐', desc: "Engagement de non-divulgation signé par le salarié", pop: false },
    { id: 'decl_embauche', factproType: 'service_report', name: "Déclaration d embauche", icon: '📑', desc: "Déclaration préalable d embauche auprès des organismes", pop: false },
    { id: 'recu_materiel', factproType: 'receipt', name: "Reçu remise matériel", icon: '📦', desc: "Accusé de réception des équipements remis au salarié", pop: false },
    { id: 'fiche_form_rh', factproType: 'service_report', name: "Fiche formation RH", icon: '📚', desc: "Suivi des formations suivies par le salarié", pop: false },
    { id: 'registre_pers', factproType: 'service_report', name: "Registre du personnel", icon: '📒', desc: "Fiche individuelle de chaque salarié de l entreprise", pop: false },
    { id: 'attest_stage', factproType: 'service_report', name: "Attestation de stage", icon: '🎖️', desc: "Certification officielle de la réalisation du stage", pop: true },
  ]},
  { id: 'admin', label: 'Administratif & Juridique', icon: '⚖️', color: '#4F46E5', docs: [
    ...
    { id: 'statuts_soc', factproType: 'service_report', name: "Statuts de Société", icon: '🏛️', desc: "Document fondateur de la personne morale", pop: true },
    { id: 'regl_int', factproType: 'service_report', name: "Règlement Intérieur", icon: '📋', desc: "Charte des règles internes de l'entreprise", pop: false },
    { id: 'deleg_pouv', factproType: 'service_report', name: "Délégation de Pouvoirs", icon: '🤝', desc: "Transfert autorité à un représentant désigné", pop: true },
    { id: 'procuration', factproType: 'service_report', name: "Procuration", icon: '✍️', desc: "Mandat donné à un tiers pour agir", pop: true },
    { id: 'conv_part', factproType: 'service_report', name: "Convention Partenariat", icon: '🔗', desc: "Accord formel entre deux entités partenaires", pop: true },
    { id: 'accord_conf', factproType: 'service_report', name: "Accord Confidentialité", icon: '🔒', desc: "Protection des informations sensibles partagées", pop: true },
    { id: 'charte_eth', factproType: 'service_report', name: "Charte Éthique", icon: '⚖️', desc: "Engagements déontologiques de organisation", pop: false },
    { id: 'rapport_ag', factproType: 'service_report', name: "Rapport AG", icon: '📊', desc: "Compte-rendu officiel des délibérations AG", pop: false },
    { id: 'resol_cons', factproType: 'service_report', name: "Résolution du Conseil", icon: '📜', desc: "Décision formelle du conseil d'administration", pop: false },
    { id: 'avis_conv_ag', factproType: 'service_report', name: "Avis Convocation AG", icon: '📣', desc: "Convocation officielle des actionnaires à l'assemblée", pop: false },
    { id: 'lettre_notif', factproType: 'service_report', name: "Lettre Notification", icon: '📨', desc: "Communication officielle à une partie concernée", pop: false },
    { id: 'dem_autor', factproType: 'service_report', name: "Demande Autorisation", icon: '📝', desc: "Requête formelle auprès d'une autorité", pop: false },
    { id: 'recep_depot', factproType: 'receipt', name: "Récépissé de Dépôt", icon: '🗂️', desc: "Preuve de dépôt d'un document officiel", pop: false },
    { id: 'decis_dir', factproType: 'service_report', name: "Décision de Direction", icon: '📌', desc: "Acte unilatéral émanant de la direction", pop: false },
    { id: 'accord_trans', factproType: 'service_report', name: "Accord Transactionnel", icon: '🤜', desc: "Règlement amiable d'un différend entre parties", pop: false },
    { id: 'cdc_ao', factproType: 'service_report', name: "Cahier des Charges AO", icon: '📂', desc: "Spécifications pour un appel d'offres public", pop: true },
    { id: 'memoire_exp', factproType: 'service_report', name: "Mémoire Explicatif", icon: '📄', desc: "Note détaillée justifiant une demande ou projet", pop: false },
    { id: 'lettre_resil', factproType: 'service_report', name: "Lettre de Résiliation", icon: '❌', desc: "Notification formelle de fin de contrat", pop: true },
    { id: 'avis_reun', factproType: 'service_report', name: "Avis Convocation Réunion", icon: '📅', desc: "Invitation officielle à une réunion interne", pop: false },
    { id: 'cr_reun', factproType: 'service_report', name: "Compte-Rendu Réunion", icon: '📓', desc: "Synthèse des décisions prises en réunion", pop: true },
    { id: 'proto_accord', factproType: 'service_report', name: "Protocole Accord", icon: '🤲', desc: "Document préparatoire à un accord définitif", pop: false },
    { id: 'lettre_gar', factproType: 'service_report', name: "Lettre de Garantie", icon: '🛡️', desc: "Engagement de garantie émis par une entité", pop: true },
    { id: 'attest_stage', factproType: 'service_report', name: "Attestation Stage Étudiant", icon: '🏅', desc: "Certificat de réalisation d'un stage académique", pop: true },
  ]},
  { id: 'immobilier', label: 'Immobilier & Location', icon: '🏠', color: '#DB2777', docs: [
    ...
    { id: 'prom_vente', factproType: 'service_report', name: "Promesse de Vente", icon: '🏠', desc: "Engagement unilatéral de vendre un bien immobilier", pop: true },
    { id: 'compro_vente', factproType: 'service_report', name: "Compromis de Vente", icon: '🏡', desc: "Accord bilatéral avant acte de vente définitif", pop: true },
    { id: 'mand_vente', factproType: 'service_report', name: "Mandat de Vente", icon: '📋', desc: "Délégation à un agent pour vendre un bien", pop: true },
    { id: 'mand_loc', factproType: 'service_report', name: "Mandat de Location", icon: '🔑', desc: "Autorisation de louer un bien par un mandataire", pop: false },
    { id: 'fiche_bien', factproType: 'service_report', name: "Fiche Descriptive Bien", icon: '🏢', desc: "Description technique d'un bien immobilier", pop: false },
    { id: 'rapp_visite', factproType: 'service_report', name: "Rapport de Visite", icon: '👁️', desc: "Compte-rendu d'une visite d'un bien immobilier", pop: false },
    ...
    { id: 'acte_caution', factproType: 'service_report', name: "Acte de Caution", icon: '🤝', desc: "Engagement d'un garant pour un locataire", pop: false },
    { id: 'edl_contra', factproType: 'service_report', name: "État des Lieux", icon: '🏚️', desc: "Constat contradictoire de l'état du logement", pop: true },
    { id: 'notice_loc', factproType: 'service_report', name: "Notice Info Locataire", icon: 'ℹ️', desc: "Document d'information remis au nouveau locataire", pop: false },
    ...
    { id: 'resil_bail', factproType: 'service_report', name: "Résiliation de Bail", icon: '🚪', desc: "Document officiel de fin de bail locatif", pop: true },
    ...
    { id: 'attest_dom', factproType: 'service_report', name: "Attestation de Domicile", icon: '🏠', desc: "Justificatif officiel du lieu de résidence", pop: true },
    { id: 'fiche_loc', factproType: 'service_report', name: "Fiche Rens. Locataire", icon: '📋', desc: "Dossier de candidature du locataire potentiel", pop: false },
  ]},
  { id: 'export', label: 'Export & Douane', icon: '🌍', color: '#B45309', docs: [
    ...
    { id: 'cert_phyto', factproType: 'service_report', name: "Certificat Phytosanitaire", icon: '🌿', desc: "Contrôle sanitaire des végétaux à l'export", pop: true },
    { id: 'cert_sanit', factproType: 'service_report', name: "Certificat Sanitaire", icon: '🩺', desc: "Attestation de conformité sanitaire produits animaux", pop: true },
    { id: 'carnet_ata', factproType: 'service_report', name: "Carnet ATA", icon: '🗃️', desc: "Admission temporaire internationale de marchandises", pop: false },
    ...
    { id: 'cert_inspec', factproType: 'service_report', name: "Certificat Inspection", icon: '🔍', desc: "Attestation de conformité par un organisme tiers", pop: true },
    ...
    { id: 'decl_valeur', factproType: 'service_report', name: "Déclaration de Valeur", icon: '💲', desc: "Déclaration officielle de la valeur marchande exportée", pop: false },
    ...
    { id: 'cert_ass_tr', factproType: 'service_report', name: "Certificat Assurance Transport", icon: '🛡️', desc: "Couverture assurance pour marchandises en transit", pop: false },
  ]},
  { id: 'sante', label: 'Santé & Médical', icon: '🏥', color: '#0891B2', docs: [
    ...
    { id: 'cert_med', factproType: 'service_report', name: "Certificat Médical", icon: '🩺', desc: "Attestation médicale émise par un praticien", pop: true },
    { id: 'rapp_radio', factproType: 'service_report', name: "Rapport de Radiologie", icon: '🔬', desc: "Résultats d'un examen radiologique interprété", pop: false },
    { id: 'consent_pat', factproType: 'service_report', name: "Consentement Patient", icon: '✍️', desc: "Accord éclairé du patient avant un acte médical", pop: true },
    { id: 'fiche_pat', factproType: 'service_report', name: "Fiche Patient", icon: '📋', desc: "Dossier d'identification et antécédents patient", pop: true },
    { id: 'rapp_consult', factproType: 'service_report', name: "Rapport de Consultation", icon: '📝', desc: "Compte-rendu d'une consultation médicale effectuée", pop: false },
    ...
    { id: 'prescr_kine', factproType: 'service_report', name: "Prescription Kiné", icon: '💪', desc: "Ordonnance pour séances de kinésithérapie prescrites", pop: false },
    { id: 'cert_aptit', factproType: 'service_report', name: "Certificat Aptitude Médicale", icon: '✅', desc: "Attestation d'aptitude physique pour une activité", pop: true },
    { id: 'fiche_vaccin', factproType: 'service_report', name: "Fiche de Vaccination", icon: '💉', desc: "Carnet de suivi des vaccinations reçues", pop: false },
    { id: 'bon_exam_sp', factproType: 'service_report', name: "Bon Examens Spécialisés", icon: '🔭', desc: "Prescription d'examens auprès de spécialistes", pop: false },
    { id: 'rapp_operat', factproType: 'service_report', name: "Rapport Opératoire", icon: '⚕️', desc: "Compte-rendu d'une intervention chirurgicale", pop: false },
    { id: 'doss_med_s', factproType: 'service_report', name: "Dossier Médical Simplifié", icon: '📁', desc: "Synthèse simplifiée du dossier médical patient", pop: false },
    { id: 'attest_med_a', factproType: 'service_report', name: "Attestation Médicale Assurance", icon: '📄', desc: "Document médical requis pour remboursement assurance", pop: true },
  ...
  { id: 'education', label: 'Éducation & Formation', icon: '🎓', color: '#7C3AED', docs: [
    ...
    { id: 'contrat_form', factproType: 'service_report', name: "Contrat de Formation", icon: '📘', desc: "Accord de formation professionnelle entre parties", pop: true },
    { id: 'cert_scol', factproType: 'service_report', name: "Certificat de Scolarité", icon: '🎓', desc: "Attestation officielle d'inscription dans un établissement", pop: true },
    { id: 'prog_pedag', factproType: 'service_report', name: "Programme Pédagogique", icon: '📚', desc: "Plan détaillé des contenus et objectifs de formation", pop: false },
    { id: 'diplome_cert', factproType: 'service_report', name: "Diplôme / Certificat", icon: '🎖️', desc: "Titre officiel attestant une qualification obtenue", pop: true },
    { id: 'convoc_exam', factproType: 'service_report', name: "Convocation Examen", icon: '📅', desc: "Document officiel de convocation à un examen", pop: true },
    { id: 'releve_notes', factproType: 'service_report', name: "Relevé de Notes", icon: '📊', desc: "Récapitulatif des résultats académiques d'un élève", pop: true },
    { id: 'lettre_recom', factproType: 'service_report', name: "Lettre Recommandation", icon: '⭐', desc: "Recommandation écrite pour un étudiant méritant", pop: false },
    { id: 'fiche_inscr', factproType: 'service_report', name: "Fiche Inscription", icon: '📝', desc: "Formulaire d'enregistrement d'un apprenant", pop: true },
    { id: 'accord_alter', factproType: 'service_report', name: "Accord Alternance", icon: '🔄', desc: "Convention entre entreprise et établissement scolaire", pop: false },
    { id: 'planning_crs', factproType: 'service_report', name: "Planning de Cours", icon: '🗓️', desc: "Calendrier détaillé des séances de cours prévues", pop: false },
    { id: 'rapp_pedag', factproType: 'service_report', name: "Rapport Pédagogique", icon: '📋', desc: "Bilan des activités et résultats pédagogiques", pop: false },
    ...
    { id: 'cert_fin_for', factproType: 'service_report', name: "Certificat Fin Formation", icon: '🏆', desc: "Attestation de réussite et fin d'une formation", pop: true },
    { id: 'autor_par', factproType: 'service_report', name: "Autorisation Parentale", icon: '👨‍👧', desc: "Accord parental pour une sortie scolaire organisée", pop: false },
    { id: 'liste_fourni', factproType: 'service_report', name: "Liste de Fournitures", icon: '✏️', desc: "Liste officielle des fournitures scolaires requises", pop: false },
  ]},
  { id: 'resto',  label: 'Restauration & Hôtellerie', icon: '🍽️', color: '#EA580C', docs: [
    { id: 'note_table', factproType: 'receipt', name: "Note de Table", icon: '🧾', desc: "Addition client en fin de repas au restaurant", pop: true },
    ...
    { id: 'resa_table', factproType: 'receipt', name: "Réservation Table", icon: '📞', desc: "Confirmation de réservation de table restaurant", pop: true },
    ...
    { id: 'fiche_chambre', factproType: 'service_report', name: "Fiche de Chambre", icon: '🛏️', desc: "Fiche client et consommations par chambre occupée", pop: true },
    { id: 'etat_ch_hotel', factproType: 'service_report', name: "État Lieux Chambre", icon: '🔍', desc: "Constat état chambre à l'entrée et sortie client", pop: false },
    ...
    { id: 'fiche_prod_r', factproType: 'service_report', name: "Fiche de Production", icon: '📊', desc: "Suivi de production journalière en cuisine professionnelle", pop: false },
    { id: 'rapport_jr_r', factproType: 'service_report', name: "Rapport Journalier", icon: '📝', desc: "Bilan quotidien des activités et ventes restaurant", pop: false },
    { id: 'planning_res', factproType: 'service_report', name: "Planning Personnel", icon: '🗓️', desc: "Planning hebdomadaire du personnel de restauration", pop: false },
    ...
    { id: 'fiche_stk_bar', factproType: 'service_report', name: "Fiche Stock Bar", icon: '🍺', desc: "État des stocks et mouvements au comptoir bar", pop: false },
    ...
    { id: 'rpt_caisse_r', factproType: 'service_report', name: "Rapport Caisse Resto", icon: '💰', desc: "Rapport de caisse journalier du point de vente", pop: true },
    { id: 'fiche_entr_ch', factproType: 'service_report', name: "Fiche Entretien Chambre", icon: '🧹', desc: "Suivi du nettoyage et entretien des chambres hôtel", pop: false },
    { id: 'rapport_haccp', factproType: 'service_report', name: "Rapport HACCP", icon: '✅', desc: "Rapport de contrôle hygiène et sécurité alimentaire", pop: false },
  ...
  { id: 'garage', label: 'Auto & Garage',             icon: '🚗', color: '#1D4ED8', docs: [
    { id: 'ordre_rep_auto', factproType: 'service_report', name: "Ordre Réparation Auto", icon: '🔧', desc: "Autorisation officielle de réparation d'un véhicule client", pop: true },
    { id: 'fiche_veh', factproType: 'service_report', name: "Fiche Véhicule Client", icon: '🚘', desc: "Dossier complet du véhicule client en atelier", pop: true },
    { id: 'rapport_exp_v', factproType: 'service_report', name: "Rapport Expertise Véhicule", icon: '🔍', desc: "Évaluation technique détaillée d'un véhicule sinistré", pop: false },
    ...
    { id: 'bon_trav_auto', factproType: 'service_report', name: "Bon de Travaux Auto", icon: '🛠️', desc: "Liste des opérations effectuées sur le véhicule", pop: true },
    { id: 'cert_rev', factproType: 'receipt', name: "Certificat de Révision", icon: '✅', desc: "Attestation officielle de révision périodique effectuée", pop: false },
    { id: 'fiche_ct', factproType: 'service_report', name: "Fiche Contrôle Technique", icon: '📝', desc: "Résultat complet du contrôle technique véhicule", pop: false },
    ...
    { id: 'permis_circ', factproType: 'receipt', name: "Permis Circuler Provisoire", icon: '🪪', desc: "Autorisation temporaire de circulation du véhicule", pop: false },
    ...
    { id: 'rapport_acc', factproType: 'service_report', name: "Rapport Accident Véhicule", icon: '🚨', desc: "Constat et rapport détaillé suite à un accident", pop: false },
    { id: 'fiche_entr_p', factproType: 'service_report', name: "Fiche Entretien Préventif", icon: '📅', desc: "Suivi périodique des entretiens préventifs du véhicule", pop: true },
    { id: 'attest_rep', factproType: 'receipt', name: "Attestation de Réparation", icon: '📄', desc: "Certificat confirmant la réparation effectuée en atelier", pop: false },
    { id: 'bon_gar_piece', factproType: 'receipt', name: "Bon de Garantie Pièce", icon: '🛡️', desc: "Document de garantie sur une pièce installée", pop: false },
    { id: 'rapport_diag', factproType: 'service_report', name: "Rapport Diagnostic Électron.", icon: '💻', desc: "Rapport de diagnostic électronique du véhicule", pop: true },
  ...
  { id: 'it',     label: 'Informatique & IT',         icon: '💻', color: '#6D28D9', docs: [
    { id: 'it_cdc', factproType: 'service_report', name: "Cahier des Charges IT", icon: '📘', desc: "Spécifications techniques et fonctionnelles d'un projet IT", pop: true },
    ...
    { id: 'it_contrat_m', factproType: 'service_report', name: "Contrat Maintenance Info", icon: '🔄', desc: "Contrat de maintenance et support informatique régulier", pop: true },
    { id: 'it_ticket', factproType: 'service_report', name: "Ticket Incident IT", icon: '🎫', desc: "Enregistrement et suivi d'un incident informatique", pop: true },
    { id: 'it_rapport_int', factproType: 'service_report', name: "Rapport Intervention IT", icon: '📊', desc: "Rapport d'intervention technique sur site ou à distance", pop: true },
    ...
    { id: 'it_contrat_lic', factproType: 'service_report', name: "Contrat Licence Logiciel", icon: '📜', desc: "Accord de licence et conditions d'utilisation logiciel", pop: false },
    { id: 'it_audit_sec', factproType: 'service_report', name: "Rapport Audit Sécurité", icon: '🔐', desc: "Analyse des vulnérabilités et recommandations sécurité", pop: false },
    { id: 'it_pra', factproType: 'service_report', name: "Plan Reprise Activité", icon: '♻️', desc: "Plan de continuité et reprise après sinistre informatique", pop: false },
    ...
    { id: 'it_fiche_conf', factproType: 'service_report', name: "Fiche de Configuration", icon: '⚙️', desc: "Paramétrage technique documenté d'un équipement", pop: false },
    { id: 'it_rapport_p', factproType: 'service_report', name: "Rapport de Projet IT", icon: '📈', desc: "Avancement et bilan d'un projet informatique", pop: false },
    ...
    { id: 'it_attest_f', factproType: 'receipt', name: "Attest. Formation Inform.", icon: '🎓', desc: "Attestation de participation à une formation informatique", pop: false },
    { id: 'it_pv_recette', factproType: 'receipt', name: "PV de Recette Logiciel", icon: '✔️', desc: "Procès-verbal de validation et recette d'un logiciel", pop: true },
    { id: 'it_rapport_bk', factproType: 'service_report', name: "Rapport de Sauvegarde", icon: '💾', desc: "Compte-rendu de l'état des sauvegardes effectuées", pop: false },
    { id: 'it_fiche_test', factproType: 'service_report', name: "Fiche de Test", icon: '🧪', desc: "Cas de test et résultats de validation fonctionnelle", pop: false },
  ]},
  { id: 'agri',   label: 'Agriculture & Élevage',     icon: '🌱', color: '#16A34A', docs: [
    ...
    { id: 'agri_fiche_parc', factproType: 'service_report', name: "Fiche Parcelle", icon: '🗺️', desc: "Données techniques et historique d'une parcelle agricole", pop: true },
    ...
    { id: 'agri_tracab', factproType: 'service_report', name: "Traçabilité Produit", icon: '🔍', desc: "Suivi complet du produit agricole de champ à marché", pop: false },
    ...
    { id: 'agri_fiche_troup', factproType: 'service_report', name: "Fiche Troupeau", icon: '🐄', desc: "Recensement et suivi du cheptel par espèce", pop: false },
    { id: 'agri_rapp_prod', factproType: 'service_report', name: "Rapport Production", icon: '📊', desc: "Bilan mensuel ou saisonnier de production agricole", pop: true },
    ...
    { id: 'agri_cert_phyto', factproType: 'service_report', name: "Cert. Phytosanitaire", icon: '🌿', desc: "Attestation interne de conformité sanitaire des cultures", pop: false },
    { id: 'agri_plan_cult', factproType: 'service_report', name: "Planning Cultural", icon: '📅', desc: "Calendrier des travaux agricoles par campagne", pop: false },
    { id: 'agri_fiche_elev', factproType: 'service_report', name: "Fiche Élevage", icon: '🐓', desc: "Suivi quotidien alimentation et croissance animale", pop: false },
    { id: 'agri_rapp_vet', factproType: 'service_report', name: "Rapport Vétérinaire", icon: '🩺', desc: "Compte rendu des soins et diagnostics vétérinaires", pop: false },
    { id: 'agri_bon_vacc', factproType: 'service_report', name: "Bon Vaccination", icon: '💉', desc: "Enregistrement des vaccinations par animal ou lot", pop: false },
    { id: 'agri_cont_meta', factproType: 'service_report', name: "Contrat Métayage", icon: '🤝', desc: "Accord de partage de récolte entre propriétaire et métayer", pop: false },
    { id: 'agri_attest_bio', factproType: 'service_report', name: "Attest. Production Bio", icon: '♻️', desc: "Attestation interne de conformité agriculture biologique", pop: false },
  ]},
  { id: 'enrg',   label: 'Énergie Solaire',           icon: '☀️', color: '#F59E0B', docs: [
    ...
    { id: 'enrg_cont_inst', factproType: 'service_report', name: "Contrat Installation", icon: '📋', desc: "Accord contractuel pour travaux d'installation solaire", pop: true },
    ...
    { id: 'enrg_pv_service', factproType: 'service_report', name: "PV Mise en Service", icon: '✅', desc: "Procès-verbal officiel de mise en service installation", pop: true },
    { id: 'enrg_rapp_prod', factproType: 'service_report', name: "Rapport Production", icon: '⚡', desc: "Relevé de la production d'énergie solaire générée", pop: false },
    { id: 'enrg_releve_cpt', factproType: 'service_report', name: "Relevé Compteur", icon: '🔌', desc: "Lecture périodique du compteur électrique du site", pop: false },
    { id: 'enrg_cont_maint', factproType: 'service_report', name: "Contrat Maintenance", icon: '🛠️', desc: "Accord de maintenance préventive et curative solaire", pop: false },
    ...
    { id: 'enrg_attest_elec', factproType: 'service_report', name: "Attest. Conformité", icon: '🏅', desc: "Attestation de conformité électrique de l'installation", pop: false },
    { id: 'enrg_rapp_ctrl', factproType: 'service_report', name: "Rapport Contrôle", icon: '📝', desc: "Rapport de contrôle périodique de l'installation solaire", pop: false },
    { id: 'enrg_fiche_tech', factproType: 'service_report', name: "Fiche Technique", icon: '📄', desc: "Spécifications techniques du panneau ou équipement solaire", pop: false },
    { id: 'enrg_gar_mater', factproType: 'service_report', name: "Garantie Matériel", icon: '🛡️', desc: "Document de garantie fabricant pour matériel solaire", pop: false },
    { id: 'enrg_audit_enrg', factproType: 'service_report', name: "Rapport Audit Énergie", icon: '🔎', desc: "Analyse des consommations et potentiel d'économie énergétique", pop: false },
    { id: 'enrg_cont_rach', factproType: 'service_report', name: "Contrat Rachat Énergie", icon: '🔄', desc: "Accord de rachat de surplus d'énergie solaire produite", pop: false },
  ]},
  { id: 'banq',   label: 'Banque & Microfinance',     icon: '🏦', color: '#1E40AF', docs: [
    { id: 'banq_dem_credit', factproType: 'service_report', name: "Demande de Crédit", icon: '📩', desc: "Formulaire de demande de prêt par un client", pop: true },
    { id: 'banq_anal_cred', factproType: 'service_report', name: "Fiche Analyse Crédit", icon: '🔬', desc: "Évaluation financière et risque d'un dossier de crédit", pop: true },
    { id: 'banq_tab_amort', factproType: 'service_report', name: "Tableau Amortissement", icon: '📉', desc: "Échéancier détaillé des remboursements d'un prêt accordé", pop: true },
    { id: 'banq_cont_pret', factproType: 'service_report', name: "Contrat de Prêt", icon: '📜', desc: "Contrat officiel liant l'institution et l'emprunteur", pop: true },
    { id: 'banq_act_nant', factproType: 'service_report', name: "Acte Nantissement", icon: '🏦', desc: "Mise en garantie d'un bien mobilier pour sûreté crédit", pop: false },
    { id: 'banq_cont_caut', factproType: 'service_report', name: "Contrat de Caution", icon: '🤝', desc: "Engagement d'un tiers à garantir le remboursement du prêt", pop: false },
    ...
    { id: 'banq_fiche_remb', factproType: 'receipt', name: "Fiche Remboursement", icon: '🔁', desc: "Enregistrement de chaque remboursement effectué par client", pop: true },
    { id: 'banq_attest_sold', factproType: 'service_report', name: "Attest. Crédit Soldé", icon: '✔️', desc: "Attestation confirmant le remboursement total du crédit", pop: true },
    { id: 'banq_dem_eparg', factproType: 'service_report', name: "Demande d'Épargne", icon: '🏧', desc: "Ouverture ou modification d'un compte épargne client", pop: false },
    { id: 'banq_releve_epg', factproType: 'service_report', name: "Relevé Épargne", icon: '📒', desc: "Historique des mouvements sur compte épargne client", pop: false },
    { id: 'banq_avis_prel', factproType: 'service_report', name: "Avis de Prélèvement", icon: '📤', desc: "Notification de prélèvement automatique sur compte client", pop: false },
    { id: 'banq_attest_vir', factproType: 'service_report', name: "Attest. Virement", icon: '➡️', desc: "Confirmation d'exécution d'un virement bancaire effectué", pop: false },
    { id: 'banq_cont_leas', factproType: 'service_report', name: "Contrat de Leasing", icon: '🚜', desc: "Accord de location-financement d'un équipement professionnel", pop: false },
    { id: 'banq_fiche_kyc', factproType: 'service_report', name: "Fiche KYC Client", icon: '🪪', desc: "Connaissance client et vérification d'identité réglementaire", pop: true },
    { id: 'banq_decl_pat', factproType: 'service_report', name: "Décl. Patrimoine", icon: '🏡', desc: "Déclaration des actifs et passifs du demandeur de crédit", pop: false },
    { id: 'banq_rapp_visit', factproType: 'service_report', name: "Rapport Visite Crédit", icon: '🚶', desc: "Compte rendu de la visite terrain pour instruction crédit", pop: false },
    { id: 'banq_fiche_gar', factproType: 'service_report', name: "Fiche de Garantie", icon: '🔐', desc: "Détail et valorisation des garanties apportées par l'emprunteur", pop: false },
  ]},
  { id: 'ong',    label: 'ONG & Associations',        icon: '🌍', color: '#0369A1', docs: [
    { id: 'ong_rapp_act', factproType: 'service_report', name: "Rapport d'activité", icon: '📋', desc: "Bilan des activités réalisées par l'ONG", pop: true },
    ...
    { id: 'ong_conv_part', factproType: 'service_report', name: "Convention partenariat", icon: '🤝', desc: "Accord de collaboration entre organisations partenaires", pop: true },
    { id: 'ong_rapp_bail', factproType: 'service_report', name: "Rapport bailleur", icon: '📊', desc: "Rapport financier destiné aux bailleurs de fonds", pop: true },
    { id: 'ong_benevolat', factproType: 'service_report', name: "Formulaire bénévolat", icon: '🙋', desc: "Inscription et engagement d'un bénévole associatif", pop: false },
    { id: 'ong_benefic', factproType: 'service_report', name: "Fiche bénéficiaire", icon: '👤', desc: "Profil et suivi d'un bénéficiaire de projet", pop: false },
    { id: 'ong_volontariat', factproType: 'service_report', name: "Contrat volontariat", icon: '📝', desc: "Engagement contractuel d'un volontaire associatif", pop: false },
    { id: 'ong_cr_mission', factproType: 'service_report', name: "CR mission terrain", icon: '🗺️', desc: "Compte-rendu de mission effectuée sur le terrain", pop: true },
    { id: 'ong_suivi_proj', factproType: 'service_report', name: "Rapport suivi projet", icon: '📈', desc: "Suivi périodique de l'avancement d'un projet", pop: true },
    { id: 'ong_pv_ag', factproType: 'service_report', name: "PV assemblée générale", icon: '🏛️', desc: "Procès-verbal de l'assemblée générale associative", pop: false },
    { id: 'ong_bilan_ann', factproType: 'service_report', name: "Bilan annuel asso", icon: '📅', desc: "Bilan annuel financier et moral de l'association", pop: false },
    { id: 'ong_plan_act', factproType: 'service_report', name: "Plan action projet", icon: '🎯', desc: "Planification des activités et jalons du projet", pop: true },
    { id: 'ong_solli_don', factproType: 'service_report', name: "Lettre sollicitation don", icon: '✉️', desc: "Courrier de demande de don ou de subvention", pop: false },
    { id: 'ong_attest_don', factproType: 'receipt', name: "Attestation de don", icon: '🧾', desc: "Justificatif officiel de réception d'un don", pop: true },
    { id: 'ong_protocole', factproType: 'service_report', name: "Protocole d'accord", icon: '📜', desc: "Protocole d'accord entre ONG et partenaires terrain", pop: false },
  ]},
  { id: 'cons',   label: 'Audit & Conseil',           icon: '♟️', color: '#374151', docs: [
    { id: 'cons_lett_miss', factproType: 'service_report', name: "Lettre de mission", icon: '📄', desc: "Lettre définissant le périmètre de la mission audit", pop: true },
    { id: 'cons_rapp_aud', factproType: 'service_report', name: "Rapport audit financier", icon: '🔍', desc: "Rapport complet d'audit des comptes financiers", pop: true },
    { id: 'cons_due_dilig', factproType: 'service_report', name: "Rapport due diligence", icon: '🧐', desc: "Analyse approfondie de risques avant investissement", pop: true },
    { id: 'cons_plan_corr', factproType: 'service_report', name: "Plan action correctif", icon: '⚙️', desc: "Actions correctives suite aux conclusions d'audit", pop: false },
    { id: 'cons_rapp_strat', factproType: 'service_report', name: "Rapport conseil strat.", icon: '♟️', desc: "Rapport de conseil en stratégie d'entreprise", pop: true },
    { id: 'cons_fiche_miss', factproType: 'service_report', name: "Fiche de mission", icon: '🗒️', desc: "Fiche descriptive d'une mission de consultant", pop: false },
    { id: 'cons_diagnostic', factproType: 'service_report', name: "Rapport diagnostic", icon: '🏢', desc: "Diagnostic global de la situation d'une entreprise", pop: true },
    { id: 'cons_livrables', factproType: 'service_report', name: "Livrables projet", icon: '📦', desc: "Document récapitulatif des livrables remis au client", pop: false },
    { id: 'cons_cr_miss', factproType: 'service_report', name: "CR de mission", icon: '📋', desc: "Compte-rendu synthétique d'une mission de conseil", pop: false },
    ...
    { id: 'cons_contrat', factproType: 'service_report', name: "Contrat de conseil", icon: '✍️', desc: "Contrat encadrant une prestation de conseil", pop: true },
    { id: 'cons_rapp_int', factproType: 'service_report', name: "Rapport intermédiaire", icon: '🔄', desc: "Point d'étape intermédiaire d'un projet de conseil", pop: false },
    { id: 'cons_note_syn', factproType: 'service_report', name: "Note de synthèse audit", icon: '📝', desc: "Synthèse concise des conclusions de l'audit", pop: false },
    { id: 'cons_conformite', factproType: 'service_report', name: "Rapport de conformité", icon: '✅', desc: "Évaluation de la conformité réglementaire et interne", pop: false },
    { id: 'cons_attest_miss', factproType: 'receipt', name: "Attestation de mission", icon: '🎖️', desc: "Attestation officielle de réalisation d'une mission", pop: false },
  ]},
  { id: 'tour',   label: 'Tourisme & Voyages',        icon: '✈️', color: '#0EA5E9', docs: [
    ...
    { id: 'tour_prog_tour', factproType: 'service_report', name: "Programme touristique", icon: '🗺️', desc: "Itinéraire détaillé d'un circuit touristique", pop: true },
    { id: 'tour_voucher_h', factproType: 'receipt', name: "Voucher hôtel", icon: '🏨', desc: "Bon de confirmation de réservation hôtelière", pop: true },
    { id: 'tour_recu_visa', factproType: 'receipt', name: "Reçu de visa", icon: '🛂', desc: "Reçu de paiement des frais de visa voyageur", pop: false },
    ...
    { id: 'tour_contrat_to', factproType: 'service_report', name: "Contrat tour opérateur", icon: '🤝', desc: "Contrat entre agence et tour opérateur partenaire", pop: false },
    { id: 'tour_fiche_exc', factproType: 'service_report', name: "Fiche excursion", icon: '🏞️', desc: "Description et détails d'une excursion touristique", pop: false },
    { id: 'tour_passagers', factproType: 'service_report', name: "Liste passagers", icon: '👥', desc: "Manifeste des passagers d'un groupe touristique", pop: false },
    { id: 'tour_assurance', factproType: 'service_report', name: "Assurance voyage", icon: '🛡️', desc: "Document d'assurance voyage pour touriste", pop: true },
    ...
    { id: 'tour_fiche_guide', factproType: 'service_report', name: "Fiche guide touristique", icon: '🧭', desc: "Fiche d'information du guide touristique affecté", pop: false },
    { id: 'tour_satisfact', factproType: 'service_report', name: "Rapport satisfaction client", icon: '⭐', desc: "Rapport d'évaluation satisfaction client post-voyage", pop: false },
  ...
  { id: 'pharm',  label: 'Pharmacie',                 icon: '💊', color: '#BE185D', docs: [
    ...
    { id: 'pharm_stock', factproType: 'service_report', name: "Fiche stock pharmacie", icon: '📦', desc: "État du stock de produits pharmaceutiques", pop: true },
    { id: 'pharm_perempti', factproType: 'service_report', name: "Rapport péremption", icon: '⚠️', desc: "Liste des médicaments en fin de date de péremption", pop: true },
    ...
    { id: 'pharm_dispens', factproType: 'service_report', name: "Fiche dispensation", icon: '🏥', desc: "Fiche de remise de médicaments au patient", pop: false },
    { id: 'pharm_inventair', factproType: 'service_report', name: "Rapport inventaire pharma", icon: '📋', desc: "Inventaire complet du stock de la pharmacie", pop: false },
    ...
    { id: 'pharm_tracab', factproType: 'service_report', name: "Traçabilité lot", icon: '🔎', desc: "Fiche de traçabilité d'un lot de médicaments", pop: false },
    { id: 'pharm_cert_ana', factproType: 'service_report', name: "Certificat d'analyse", icon: '🔬', desc: "Certificat d'analyse de qualité d'un produit", pop: false },
    { id: 'pharm_amm', factproType: 'service_report', name: "Autorisation mise marché", icon: '📜', desc: "Autorisation officielle de mise sur le marché", pop: false },
    { id: 'pharm_inspect', factproType: 'service_report', name: "Rapport inspection pharma", icon: '🏛️', desc: "Rapport d'inspection de l'officine pharmaceutique", pop: false },
    { id: 'pharm_destruct', factproType: 'service_report', name: "Bon destruction médic.", icon: '🗑️', desc: "Bon de destruction de médicaments non conformes", pop: false },
    { id: 'pharm_fiche_pat', factproType: 'service_report', name: "Fiche patient pharmacie", icon: '👤', desc: "Dossier patient suivi par la pharmacie", pop: true },
  ...
  { id: 'mine',   label: 'Mines & Carrières',         icon: '⛏️', color: '#78350F', docs: [
    { id: 'mine_permis', factproType: 'service_report', name: "Permis d'exploitation", icon: '⛏️', desc: "Permis officiel d'exploitation minière ou carrière", pop: true },
    { id: 'mine_rapp_geo', factproType: 'service_report', name: "Rapport géologique", icon: '🪨', desc: "Rapport d'étude géologique du site minier", pop: true },
    ...
    { id: 'mine_rapp_prod', factproType: 'service_report', name: "Rapport production mines", icon: '📈', desc: "Rapport mensuel de production minière", pop: true },
    { id: 'mine_fiche_secu', factproType: 'service_report', name: "Fiche sécurité mine", icon: '⛑️', desc: "Fiche de consignes de sécurité du site minier", pop: false },
    { id: 'mine_rapp_env', factproType: 'service_report', name: "Rapport environnemental", icon: '🌿', desc: "Rapport d'impact environnemental de l'exploitation", pop: true },
    ...
    { id: 'mine_attest_exp', factproType: 'receipt', name: "Attestation exploitation", icon: '📜', desc: "Attestation officielle du droit d'exploiter le site", pop: false },
    { id: 'mine_fiche_tech', factproType: 'service_report', name: "Fiche technique minerai", icon: '🔩', desc: "Caractéristiques techniques d'un minerai extrait", pop: false },
    { id: 'mine_ctrl_carr', factproType: 'service_report', name: "Rapport contrôle carrière", icon: '🏗️', desc: "Rapport de contrôle technique d'une carrière", pop: false },
    { id: 'mine_cert_conf', factproType: 'receipt', name: "Certificat conformité mines", icon: '✅', desc: "Certification de conformité des opérations minières", pop: false },
  ]},
]

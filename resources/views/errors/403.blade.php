...
<head>
    ...
    <title>403 — Accès refusé | IBIG FactPro</title>
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes pulse-glow {
            0%, 100% { filter: drop-shadow(0 0 30px rgba(239,68,68,0.4)); }
        ...
        .divider {
            width: 60px;
            height: 3px;
            background: linear-gradient(90deg, #ef4444, #F0C040);
            border-radius: 2px;
            margin: 1.5rem auto;
        }
...
<body>
    ...
    <div class="orb" style="width:400px;height:400px;background:#ef4444;top:-100px;right:-100px;--dur:22s;--tx:-60px;--ty:40px;opacity:0.08;"></div>
    <div class="orb" style="width:300px;height:300px;background:#0062CC;bottom:-80px;left:-80px;--dur:18s;--tx:50px;--ty:-30px;"></div>

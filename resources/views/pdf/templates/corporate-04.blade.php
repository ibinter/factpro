...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Serif, serif; font-size: 10px; color: #3D1F00; margin: 0; background: #FDF6EC; }
    ...
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #6B2737; color: #FDF6EC; padding: 8px 12px;
        border-bottom: 3px solid #C9A227; }
    .company-name { font-size: 16px; font-weight: bold; color: #C9A227; letter-spacing: 1px; }
    .company-meta { font-size: 8px; color: #F0D9C0; line-height: 1.5; }
    .doc-title { font-size: 18px; font-weight: bold; color: #FDF6EC; text-align: right; text-transform: uppercase; letter-spacing: 2px; }
    .doc-number { font-size: 10px; color: #C9A227; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B2737; border-top: 2px solid #C9A227; padding-top: 6px;
        background: #FDF6EC; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #C9A227; border-top: 3px solid #6B2737; padding: 10px 12px; background: #fff; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #6B2737; letter-spacing: 1px; }
    ...
    .meta-table .k { color: #6B2737; font-style: italic; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #6B2737; color: #C9A227; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #E8D5C0; font-size: 9.5px; }
    ...
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #E8D5C0; }
    table.totals .k { color: #6B2737; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #6B2737; color: #C9A227; font-size: 12px; font-weight: bold; border: none; }
    ...
    .notes .title { font-weight: bold; color: #6B2737; margin-bottom: 3px; }
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right; color:#6B2737;">Propulsé par <b>IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>

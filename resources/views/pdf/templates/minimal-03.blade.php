...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        ...
        color: rgba(155,28,28,0.12); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #fff; padding: 8px 12px; border-bottom: 2px solid #9B1C1C; }
    .company-name { font-size: 15px; font-weight: bold; color: #111; letter-spacing: 0.5px; }
    .company-meta { font-size: 8px; color: #555; line-height: 1.5; }
    .doc-title { font-size: 18px; font-weight: bold; color: #9B1C1C; text-align: right; text-transform: uppercase; letter-spacing: 3px; }
    .doc-number { font-size: 10px; color: #888; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #888; border-top: 1px solid #9B1C1C; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border-left: 3px solid #9B1C1C; padding: 10px 12px; background: #FFF5F5; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #9B1C1C; letter-spacing: 1.5px; }
    ...
    table.lines thead th { background: #111; color: #fff; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #F3F3F3; font-size: 9.5px; }
    ...
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #F3F3F3; }
    ...
    .hash { font-size: 6.5px; color: #ccc; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#9B1C1C">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>

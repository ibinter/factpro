...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">Clinique / Hôpital</div>
            <div class="company-meta">
                ...
                @if($company->tax_id)<br>N° Agrément : {{ $company->tax_id }}@endif
            </div>
        </td>
        <td style="width:45%">
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Soins de qualité — Merci de votre confiance.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#0891B2">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Dossier médical :</td><td>{{ $document->reference }}</td></tr>@endif
    ...
    <table class="lines">
        <thead><tr>
            <th style="width:42%">Acte / Soin</th>

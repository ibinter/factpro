...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #111; margin: 0; background: #fff; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(234,88,12,0.15); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #EA580C; padding: 8px 12px; }
    .company-name { font-size: 17px; font-weight: bold; color: #fff; letter-spacing: 1px; }
    .ubuntu-tag { font-size: 8px; color: #FDBA74; letter-spacing: 3px; text-transform: uppercase; margin-top: 1px; }
    ...
    .doc-number { font-size: 10px; color: #FDBA74; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #555; border-top: 3px solid #EA580C; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border-left: 5px solid #EA580C; padding: 10px 12px; background: #FFF7ED; }
    ...
    table.totals .v { text-align: right; font-weight: bold; color: #111; }
    ...
    .hash { font-size: 6.5px; color: #FED7AA; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
    ...
    <table style="width:100%">
        <tr>
            <td style="width:55%">
                ...
                <div class="ubuntu-tag">Ubuntu — I am because we are</div>

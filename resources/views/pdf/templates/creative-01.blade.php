...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #2A2438; margin: 0; }
    ...
    /* En-tête asymétrique : bloc violet à gauche, titre corail décalé à droite */
    header { position: fixed; top: -80px; left: 0; right: 0; height: 72px; }
    header table.head { width: 100%; border-collapse: collapse; }
    .brand-block { background: #7C3AED; color: #ffffff; padding: 12px 14px; width: 58%; }
    .company-name { font-size: 17px; font-weight: bold; color: #ffffff; }
    .company-meta { font-size: 8px; color: #E4D6FF; line-height: 1.5; }
    .title-block { vertical-align: bottom; padding-left: 16px; }
    .doc-title { font-size: 20px; font-weight: bold; color: #FF6B6B; text-align: right; text-transform: uppercase; letter-spacing: 1px; }
    .doc-number { font-size: 10.5px; color: #7C3AED; text-align: right; font-weight: bold; }
    .accent-strip { background: #FDE68A; height: 4px; width: 40%; margin-left: 60%; margin-top: 4px; }

    /* Pied de page */
    footer {
        position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #8B7FA8; border-top: 3px solid #FF6B6B; padding-top: 6px;
    }

    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #F6F0FF; border-left: 4px solid #FF6B6B; padding: 10px 12px; border-radius: 4px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #FF6B6B; letter-spacing: 2px; font-weight: bold; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #7C3AED; margin: 3px 0; }
    .badge-box .company-meta { color: #8B7FA8; }

    .meta-table { margin-top: 8px; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #FF6B6B; font-weight: bold; }

    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th {
        background: #7C3AED; color: #ffffff; padding: 7px 8px; font-size: 9px;
        text-transform: uppercase; letter-spacing: 0.5px; text-align: left;
    }
    table.lines thead th.num, table.lines td.num { text-align: right; }
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #EBE3F7; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #FAF7FF; }
    ...
    table.totals .k { color: #8B7FA8; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #FF6B6B; color: #ffffff; font-size: 12px; font-weight: bold; }
    ...
    .qr-caption { font-size: 7px; color: #8B7FA8; margin-top: 2px; }
    .notes { font-size: 9px; color: #444; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #7C3AED; margin-bottom: 3px; font-size: 9px; }
    .hash { font-size: 6.5px; color: #B4A8CC; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">
                Propulsé par <b style="color:#7C3AED">IBIG FactPro</b><br>

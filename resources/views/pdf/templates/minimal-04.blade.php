...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Serif, serif; font-size: 10px; color: #78350F; margin: 0; background: #FEFCE8; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(180,83,9,0.15); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #FEFCE8; padding: 8px 12px; border-bottom: 2px solid #B45309; }
    .company-name { font-size: 15px; font-weight: bold; color: #78350F; }
    .company-meta { font-size: 8px; color: #92400E; line-height: 1.5; }
    .doc-title { font-size: 17px; font-weight: bold; color: #B45309; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 10px; color: #A16207; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #A16207; border-top: 1px solid #B45309; padding-top: 6px;
        background: #FEFCE8; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #D97706; padding: 10px 12px; background: #FFFBEB; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #B45309; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #78350F; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #A16207; font-style: italic; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #78350F; color: #FEF3C7; padding: 7px 8px;
    ...
    table.totals .k { color: #A16207; }
    table.totals .v { text-align: right; font-weight: bold; color: #78350F; }
    table.totals tr.grand td { background: #B45309; color: #FEFCE8; font-size: 12px; font-weight: bold; border: none; }
    ...
    .qr-caption { font-size: 7px; color: #A16207; margin-top: 2px; }
    .notes { font-size: 9px; color: #78350F; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #B45309; margin-bottom: 3px; }
    .hash { font-size: 6.5px; color: #D97706; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#B45309">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            ...
            <td>
                    ...
                    @if ($document->customer)
                        ...
                        <div style="font-size:8.5px; color:#92400E; line-height:1.5">

...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #3b2400; margin: 0; background: #FFFBEB; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #92400E; border-top: 3px solid #4D7C0F; padding-top: 6px; background: #FFFBEB; }
    .company-name { font-size: 18px; font-weight: bold; color: #4D7C0F; }
    .company-meta { font-size: 8.5px; color: #92400E; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #92400E; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 11px; color: #92400E; text-align: right; }
    .sector-badge { background: #4D7C0F; color: #FFFBEB; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #fff; border-left: 4px solid #4D7C0F; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #92400E; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #4D7C0F; margin: 3px 0; }
    .meta-table { margin-top: 8px; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #92400E; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #4D7C0F; color: #FFFBEB; padding: 7px 8px; font-size: 9px;
        text-transform: uppercase; letter-spacing: 0.5px; text-align: left; }
    table.lines thead th.num, table.lines td.num { text-align: right; }
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #FDE68A; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #fff; }
    ...
    table.totals .k { color: #92400E; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #4D7C0F; color: #FFFBEB; font-size: 12px; font-weight: bold; }
    ...
    .qr-caption { font-size: 7px; color: #92400E; margin-top: 2px; }
    .notes { font-size: 9px; color: #3b2400; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #4D7C0F; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">&#127807; Exploitation Agricole</div>
            <div class="company-meta">
                ...
                @if($company->tax_id)<br>N° RCCM / Fiscal : {{ $company->tax_id }}@endif
            </div>
        </td>
        <td style="width:45%">
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Vente de produits agricoles — Merci de votre confiance.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#4D7C0F">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">Campagne / Réf. :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                <div class="label">Acheteur / Client</div>
                @if ($document->customer)
    ...
    <table class="lines">
        <thead><tr>
            <th style="width:42%">Produit / Récolte</th>

...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Serif, serif; font-size: 10px; color: #292524; margin: 0; background: #fff; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(120,113,108,0.15); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #78716C; padding: 8px 12px; border-bottom: 2px solid #D4A574; }
    .company-name { font-size: 16px; font-weight: bold; color: #D4A574; letter-spacing: 1px; }
    .company-meta { font-size: 8px; color: #E7D9D0; line-height: 1.5; }
    .doc-title { font-size: 17px; font-weight: bold; color: #fff; text-align: right; text-transform: uppercase; letter-spacing: 2px; }
    .doc-number { font-size: 10px; color: #D4A574; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #78716C; border-top: 1px solid #D4A574; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #D4A574; padding: 10px 12px; background: #FAF7F5; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #78716C; letter-spacing: 1.5px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #292524; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #78716C; font-style: italic; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #78716C; color: #D4A574; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #F0EAE5; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #FAF7F5; }
    table.totals { width: 42%; margin-left: 58%; margin-top: 12px; border-collapse: collapse; }
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #F0EAE5; }
    table.totals .k { color: #78716C; }
    table.totals .v { text-align: right; font-weight: bold; color: #292524; }
    table.totals tr.grand td { background: #78716C; color: #D4A574; font-size: 12px; font-weight: bold; border: none; }
    ...
    .notes { font-size: 9px; color: #44403C; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #78716C; margin-bottom: 3px; }
    .hash { font-size: 6.5px; color: #D4C4B8; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#78716C">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            ...
            <td>
                    ...
                    @if ($document->customer)
                        ...
                        <div style="font-size:8.5px; color:#78716C; line-height:1.5">

...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">Plomberie / Électricité</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Dépannage et installation — Intervention rapide.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
    ...
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Intervention :</td><td>{{ $document->reference }}</td></tr>@endif

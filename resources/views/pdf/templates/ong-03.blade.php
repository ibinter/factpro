...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B7280; border-top: 2px solid #B45309; padding-top: 6px; }
    ...
    .sector-badge { background: #1E3A5F; color: #fff; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #EFF6FF; border-left: 4px solid #1E3A5F; padding: 10px 12px; }
    ...
    table.lines thead th { background: #1E3A5F; color: #fff; padding: 7px 8px; font-size: 9px;
    ...
    table.totals tr.grand td { background: #1E3A5F; color: #fff; font-size: 12px; font-weight: bold; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">Fondation — Mécénat</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Mécénat et subventions — Reçu officiel.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
    ...
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">Réf. Subvention :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                <div class="label">Mécène / Donateur institutionnel</div>
                @if ($document->customer)

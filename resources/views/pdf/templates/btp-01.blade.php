...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .doc-title { font-size: 20px; font-weight: bold; color: #6B7280; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 11px; color: #6B7280; text-align: right; }
    .sector-badge { background: #6B7280; color: #fff; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #F9FAFB; border-left: 4px solid #F97316; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #9CA3AF; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #374151; margin: 3px 0; }
    ...
    table.lines thead th { background: #374151; color: #F97316; padding: 7px 8px; font-size: 9px;
    ...
    table.totals tr.grand td { background: #F97316; color: #fff; font-size: 12px; font-weight: bold; }
    ...
    .notes .title { font-weight: bold; color: #374151; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">&#127959; BTP — Bâtiment & Travaux Publics</div>
            <div class="company-meta">
                ...
                @if($company->tax_id)<br>N° Fiscal / RCCM : {{ $company->tax_id }}@endif
            </div>
        </td>
        <td style="width:45%">
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Travaux réalisés selon les règles de l\'art.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#F97316">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Chantier / Devis :</td><td>{{ $document->reference }}</td></tr>@endif
    ...
    <table class="lines">
        <thead><tr>
            <th style="width:42%">Désignation / Prestation</th>

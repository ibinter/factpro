...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #3b1f08; margin: 0; background: #FEF7EC; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #7C2D12; border-top: 2px solid #B45309; padding-top: 6px; background: #FEF7EC; }
    .company-name { font-size: 18px; font-weight: bold; color: #7C2D12; }
    .company-meta { font-size: 8.5px; color: #92400E; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #7C2D12; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 11px; color: #92400E; text-align: right; }
    .sector-badge { background: #7C2D12; color: #FEF7EC; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #fff; border-left: 4px solid #7C2D12; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #92400E; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #7C2D12; margin: 3px 0; }
    ...
    table.lines thead th { background: #7C2D12; color: #FEF7EC; padding: 7px 8px; font-size: 9px;
    ...
    table.totals tr.grand td { background: #7C2D12; color: #FEF7EC; font-size: 12px; font-weight: bold; }
    ...
    .notes { font-size: 9px; color: #3b1f08; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #7C2D12; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">&#127979; Université / Supérieur</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Frais universitaires — Merci de régler avant la date d\'échéance.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
    ...
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">Année universitaire :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                ...
                <div class="company-meta">
                    ...
                    @if($document->customer->tax_id)<br>N° Étudiant : {{ $document->customer->tax_id }}@endif
                </div>
            </div>
            @endif
        </td>

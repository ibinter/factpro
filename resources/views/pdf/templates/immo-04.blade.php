...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #1E293B; margin: 0; background: #F8FAFC; }
    ...
    header { position: fixed; top: -75px; left: 0; right: 0; height: 65px;
        background: #475569; padding: 8px 14px; border-bottom: 3px solid #4F46E5; }
    .company-name { font-size: 16px; font-weight: bold; color: #F8FAFC; }
    .company-meta { font-size: 8px; color: #CBD5E1; line-height: 1.5; }
    .doc-title { font-size: 14px; font-weight: bold; color: #A5B4FC; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 10px; color: #E2E8F0; text-align: right; }
    .syndic-tag { font-size: 7.5px; color: #C7D2FE; text-align: right; text-transform: uppercase; letter-spacing: 1px; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #475569; border-top: 2px solid #4F46E5; padding-top: 6px; background: #F8FAFC; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #CBD5E1; border-top: 3px solid #4F46E5; padding: 10px 12px; background: #fff; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #475569; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #1E293B; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #475569; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #475569; color: #F8FAFC; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #E2E8F0; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #F1F5F9; }
    table.totals { width: 42%; margin-left: 58%; margin-top: 12px; border-collapse: collapse; }
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #E2E8F0; }
    table.totals .k { color: #475569; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #4F46E5; color: #fff; font-size: 12px; font-weight: bold; border: none; }
    ...
    .notes { font-size: 9px; color: #1E293B; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #4F46E5; margin-bottom: 3px; }
...
<header>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:45%">
                <div class="syndic-tag">Syndic &amp; Copropriété</div>
...
<footer>
    <table style="width:100%">
        <tr>
            <td style="width:70%">{{ $company->invoice_footer ?? 'Syndic de copropriété — Gestion transparente et rigoureuse.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
            <td style="width:30%; text-align:right; color:#475569;">Propulsé par <b>IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            <td>
                <table class="meta-table">
                    ...
                    @if ($document->reference)<tr><td class="k">Résidence :</td><td>{{ $document->reference }}</td></tr>@endif
                    <tr><td class="k">Devise :</td><td>{{ $document->currency }}</td></tr>
                </table>
            </td>
            <td>
                    <div class="badge-box">
                        <div class="label">Copropriétaire</div>
    ...
    <table class="lines">
        <thead>
            <tr>
                <th style="width:42%">Désignation / Charges</th>

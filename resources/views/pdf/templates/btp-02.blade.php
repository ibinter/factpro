...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #555; border-top: 2px solid #F0C040; padding-top: 6px; }
    .company-name { font-size: 18px; font-weight: bold; color: #111; letter-spacing: 1px; }
    .company-meta { font-size: 8.5px; color: #555; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #F0C040; text-align: right; text-transform: uppercase; letter-spacing: 1px; }
    .doc-number { font-size: 11px; color: #555; text-align: right; }
    .sector-badge { background: #111; color: #F0C040; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #F9FAFB; border-left: 3px solid #F0C040; padding: 10px 12px; }
    ...
    .meta-table .k { color: #555; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #111; color: #F0C040; padding: 7px 8px; font-size: 9px;
    ...
    table.totals .k { color: #555; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #111; color: #F0C040; font-size: 12px; font-weight: bold; }
    ...
    .qr-caption { font-size: 7px; color: #555; margin-top: 2px; }
    .notes { font-size: 9px; color: #444; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #111; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">Architecture — Honoraires</div>
            <div class="company-meta">
                ...
                @if($company->tax_id)<br>N° Ordre Architectes : {{ $company->tax_id }}@endif
            </div>
        </td>
        <td style="width:45%">
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Honoraires d\'architecture — Conception et maîtrise d\'œuvre.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#F0C040">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Mission / Contrat :</td><td>{{ $document->reference }}</td></tr>@endif
    ...
    <table class="lines">
        <thead><tr>
            <th style="width:42%">Mission / Prestation</th>

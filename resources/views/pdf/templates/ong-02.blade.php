...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B7280; border-top: 3px solid #EAB308; padding-top: 6px; }
    .company-name { font-size: 18px; font-weight: bold; color: #16A34A; }
    .company-meta { font-size: 8.5px; color: #6B7280; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #16A34A; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 11px; color: #6B7280; text-align: right; }
    .sector-badge { background: #EAB308; color: #111; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box .name { font-size: 12px; font-weight: bold; color: #16A34A; margin: 3px 0; }
    ...
    table.totals tr.grand td { background: #16A34A; color: #fff; font-size: 12px; font-weight: bold; }
    ...
    .notes .title { font-weight: bold; color: #16A34A; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">ONG Développement</div>
            <div class="company-meta">
                ...
                @if($company->tax_id)<br>N° d'enregistrement : {{ $company->tax_id }}@endif
            </div>
        </td>
        <td style="width:45%">
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Ensemble pour un développement durable.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
...
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">Réf. Projet :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                <div class="label">Partenaire / Bailleur</div>
    ...
    <table class="lines">
        <thead><tr>
            ...
            <th class="num" style="width:14%">P.U.</th>

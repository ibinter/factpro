{{-- Collection Centenniale · Corporate Diamond · Charbon #1a1a1a + Or diamant #F0C040 --}}
@php
    $primary   = '#1a1a1a';
    $secondary = '#2b2b2b';
    $accent    = '#F0C040';
...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: 'DejaVu Sans', sans-serif; font-size: 9px; color: #2b2b2b; }
    ...
    .co-info { font-size: 7.5px; color: #cfcfcf; line-height: 1.6; margin-top: 1mm; }
    .doc-type { font-size: 21px; font-weight: bold; color: {{ $accent }}; text-transform: uppercase; text-align: right; letter-spacing: 1px; }
    .doc-num  { font-size: 8.5px; color: #d8d8d8; text-align: right; margin-top: 1mm; }
    #footer { position: fixed; bottom: -18mm; left: -13mm; right: -13mm; height: 16mm;
        border-top: 2px solid {{ $accent }}; padding: 2mm 13mm 0; font-size: 7px; color: #888; }
    #footer table { width: 100%; }
    .ft-brand { color: {{ $primary }}; font-weight: bold; }
    #watermark { position: fixed; top: 62mm; left: 28mm; font-size: 52px; font-weight: bold;
        color: rgba(240,192,64,.10); transform: rotate(-35deg); white-space: nowrap; }
    .diamond-rule { height: 4px; background: {{ $accent }}; margin-bottom: 4mm; }
    .addr-table { width: 100%; margin-bottom: 4mm; }
    .info-card { background: #f7f5ef; border-top: 2px solid {{ $accent }}; padding: 3mm 4mm; }
    ...
    .sect-label { font-size: 7px; font-weight: bold; text-transform: uppercase; color: {{ $primary }};
        letter-spacing: .8px; border-bottom: 1px solid #e3ddcb; padding-bottom: 1mm; margin-bottom: 2mm; }
    ...
    .meta-label { color: #999; font-size: 8px; } .meta-value { font-weight: bold; font-size: 8.5px; color: {{ $primary }}; }
    .lines-table { width: 100%; border-collapse: collapse; margin-bottom: 4mm; }
    .lines-table thead tr { background: {{ $primary }}; color: {{ $accent }}; }
    ...
    .lines-table tbody tr.even { background: #faf8f2; }
    .lines-table tbody td { padding: 2mm; font-size: 8px; border-bottom: 1px solid #ece7d8; vertical-align: top; }
    ...
    .row-total td { font-size: 12px; color: {{ $primary }}; background: {{ $accent }};
        border-top: 2px solid {{ $primary }}; padding: 2mm; }
    ...
    .bottom-qr img { width: 24mm; height: 24mm; } .qr-lbl { font-size: 6px; color: #999; text-align: center; margin-top: 1mm; }
    .bottom-totals { display: table-cell; vertical-align: top; }
    .notes-box { font-size: 8px; color: #555; margin-bottom: 3mm; border-top: 1px solid #ece7d8; padding-top: 2mm; }

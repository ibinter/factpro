...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #E2E8F0; background: #0D1B2A; margin: 0; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(0,212,255,0.10); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #0D1B2A; color: #00D4FF; padding: 8px 12px; border-bottom: 2px solid #A855F7; }
    .company-name { font-size: 16px; font-weight: bold; color: #00D4FF; letter-spacing: 1px; }
    .company-meta { font-size: 8px; color: #7DD3FC; line-height: 1.5; }
    .doc-title { font-size: 17px; font-weight: bold; color: #A855F7; text-align: right; text-transform: uppercase; letter-spacing: 2px; }
    .doc-number { font-size: 9px; color: #7DD3FC; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #7DD3FC; border-top: 1px solid #A855F7; padding-top: 6px; background: #0D1B2A; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #0A1628; border-left: 4px solid #00D4FF; border-top: 1px solid #A855F7; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #A855F7; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #00D4FF; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #7DD3FC; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #0A1628; color: #00D4FF; padding: 7px 8px;
        font-size: 9px; text-transform: uppercase; letter-spacing: 0.5px; text-align: left; border-bottom: 2px solid #A855F7; }
    table.lines thead th.num, table.lines td.num { text-align: right; }
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #1A2D40; font-size: 9.5px; color: #E2E8F0; }
    table.lines tbody tr:nth-child(even) td { background: #101F2E; }
    ...
    table.totals .k { color: #7DD3FC; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #0A1628; color: #00D4FF; font-size: 12px; font-weight: bold; border-top: 2px solid #A855F7; }
    table.totals tr.paid td { color: #34D399; }
    ...
    .qr-box img { width: 90px; height: 90px; border: 1px solid #00D4FF; }
    .qr-caption { font-size: 7px; color: #7DD3FC; margin-top: 2px; }
    .notes { font-size: 9px; color: #CBD5E0; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #00D4FF; margin-bottom: 3px; }
    .hash { font-size: 6.5px; color: #4A5568; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            <td style="width:70%">{{ $company->invoice_footer ?? 'Merci de votre confiance.' }}<br>{{ $document->verificationUrl() }}</td>
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#00D4FF">IBIG FactPro</b></td>
        </tr>
    </table>
</footer>
<main>
            ...
            <td>
                @if ($document->customer)
                    <div class="badge-box">
                        ...
                        <div class="company-meta" style="color:#93C5FD">

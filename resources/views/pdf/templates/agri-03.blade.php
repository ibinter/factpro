...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .company-name { font-size: 18px; font-weight: bold; color: #EA580C; }
    .company-meta { font-size: 8.5px; color: #6B7280; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #EA580C; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 11px; color: #6B7280; text-align: right; }
    .sector-badge { background: #EA580C; color: #fff; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #FFF7ED; border-left: 4px solid #EA580C; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #9CA3AF; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #EA580C; margin: 3px 0; }
    ...
    table.lines thead th { background: #EA580C; color: #fff; padding: 7px 8px; font-size: 9px;
    ...
    table.totals tr.grand td { background: #EA580C; color: #fff; font-size: 12px; font-weight: bold; }
    ...
    .notes .title { font-weight: bold; color: #EA580C; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">Agrofournitures</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Semences, engrais et intrants agricoles de qualité.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#EA580C">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">Bon de commande :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                <div class="label">Client / Agriculteur</div>
                @if ($document->customer)
    ...
    <table class="lines">
        <thead><tr>
            <th style="width:42%">Désignation / Intrant</th>

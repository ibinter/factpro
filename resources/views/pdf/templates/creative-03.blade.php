...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #111; margin: 0; background: #FFF7ED; }
    ...
    .badge-box { border-left: 4px solid #EA580C; padding: 10px 12px; background: #fff; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #EA580C; letter-spacing: 1px; }

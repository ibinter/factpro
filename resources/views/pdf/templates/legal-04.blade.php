...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Serif, serif; font-size: 10px; color: #052E16; margin: 0; background: #fff; }
    ...
    header { position: fixed; top: -75px; left: 0; right: 0; height: 65px;
        background: #14532D; color: #FEF3C7; padding: 8px 14px; border-bottom: 2px solid #4ADE80; }
    .company-name { font-size: 17px; font-weight: bold; color: #FEF3C7; }
    .company-meta { font-size: 8px; color: #A7F3D0; line-height: 1.5; }
    .doc-title { font-size: 15px; font-weight: bold; color: #FEF3C7; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 10px; color: #6EE7B7; text-align: right; }
    .env-badge { font-size: 7.5px; color: #A7F3D0; text-align: right; text-transform: uppercase; letter-spacing: 1.5px; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #14532D; border-top: 2px solid #14532D; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #86EFAC; border-left: 4px solid #14532D; padding: 10px 12px; background: #F0FFF4; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #14532D; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #052E16; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #14532D; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #14532D; color: #FEF3C7; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #BBF7D0; font-size: 9.5px; }
    ...
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #BBF7D0; }
    table.totals .k { color: #14532D; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #14532D; color: #FEF3C7; font-size: 12px; font-weight: bold; border: none; }
    ...
    .notes { font-size: 9px; color: #052E16; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #14532D; margin-bottom: 3px; }
...
<header>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:45%">
                <div class="env-badge">Cabinet Droit Environnemental</div>
...
<footer>
    <table style="width:100%">
        <tr>
            <td style="width:70%">{{ $company->invoice_footer ?? 'Cabinet spécialisé en droit de l\'environnement et développement durable.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
            <td style="width:30%; text-align:right; color:#14532D;">Propulsé par <b>IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            <td>
                <table class="meta-table">
                    ...
                    @if ($document->reference)<tr><td class="k">Dossier :</td><td>{{ $document->reference }}</td></tr>@endif

...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #14532D; margin: 0; background: #fff; }
    ...
    header { position: fixed; top: -75px; left: 0; right: 0; height: 65px;
        background: #16A34A; padding: 8px 14px; border-bottom: 3px solid #D97706; }
    .company-name { font-size: 17px; font-weight: bold; color: #fff; }
    .company-meta { font-size: 8px; color: #BBF7D0; line-height: 1.5; }
    .doc-title { font-size: 15px; font-weight: bold; color: #FDE68A; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 10px; color: #fff; text-align: right; }
    .location-tag { font-size: 7.5px; color: #A7F3D0; text-align: right; text-transform: uppercase; letter-spacing: 1px; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #16A34A; border-top: 2px solid #D97706; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #86EFAC; border-top: 3px solid #D97706; padding: 10px 12px; background: #F0FFF4; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #16A34A; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #14532D; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #16A34A; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #16A34A; color: #fff; padding: 7px 8px;
    ...
    table.totals .k { color: #16A34A; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #16A34A; color: #fff; font-size: 12px; font-weight: bold; border: none; }
    ...
    .notes { font-size: 9px; color: #14532D; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #16A34A; margin-bottom: 3px; }
...
<header>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:45%">
                <div class="location-tag">Location &amp; Gérance Immobilière</div>
...
<footer>
    <table style="width:100%">
        <tr>
            <td style="width:70%">{{ $company->invoice_footer ?? 'Gestion locative résidentielle et commerciale.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
            <td style="width:30%; text-align:right; color:#16A34A;">Propulsé par <b>IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            <td>
                <table class="meta-table">
                    ...
                    @if ($document->reference)<tr><td class="k">Réf. logement :</td><td>{{ $document->reference }}</td></tr>@endif
                    <tr><td class="k">Devise :</td><td>{{ $document->currency }}</td></tr>
                </table>
            </td>
            <td>
                    <div class="badge-box">
                        <div class="label">Locataire / Client</div>
    ...
    <table class="lines">
        <thead>
            <tr>
                <th style="width:42%">Désignation / Loyer</th>

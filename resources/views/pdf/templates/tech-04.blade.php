...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #F9FAFB; background: #1F2937; margin: 0; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(16,185,129,0.12); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #111827; color: #F9FAFB; padding: 8px 12px; border-bottom: 2px solid #10B981; }
    .company-name { font-size: 16px; font-weight: bold; color: #10B981; }
    .company-meta { font-size: 8px; color: #9CA3AF; line-height: 1.5; }
    .doc-title { font-size: 17px; font-weight: bold; color: #10B981; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 9px; color: #9CA3AF; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #9CA3AF; border-top: 2px solid #10B981; padding-top: 6px; background: #111827; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #111827; border-left: 4px solid #10B981; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #6B7280; letter-spacing: 1px; }
    ...
    table.lines thead th { background: #111827; color: #10B981; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #374151; font-size: 9.5px; color: #F9FAFB; }
    table.lines tbody tr:nth-child(even) td { background: #253041; }
    table.totals { width: 42%; margin-left: 58%; margin-top: 12px; border-collapse: collapse; }
    table.totals td { padding: 5px 8px; font-size: 10px; color: #F9FAFB; }
    table.totals .k { color: #6B7280; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #111827; color: #10B981; font-size: 12px; font-weight: bold; border-top: 2px solid #10B981; }
    ...
    .qr-box img { width: 90px; height: 90px; border: 1px solid #10B981; }
    ...
    .hash { font-size: 6.5px; color: #4B5563; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#10B981">IBIG FactPro</b></td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            ...
            <td>
                    ...
                    @if ($document->customer)
                        ...
                        <div style="font-size:8.5px; color:#9CA3AF">

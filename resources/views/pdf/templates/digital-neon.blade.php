{{-- Collection Centenniale · Digital Neon · Fond nuit #0D0D1A + Cyan néon #00F5FF --}}
@php
    $primary   = '#0D0D1A';
    $secondary = '#151528';
    $accent    = '#00F5FF';
...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: 'DejaVu Sans', sans-serif; font-size: 9px; color: #1c2333; background: #ffffff; }
    #header { position: fixed; top: -40mm; left: -13mm; right: -13mm; height: 38mm;
        background: #0D0D1A; color: #e6f9ff; padding: 6mm 13mm; }
    #header table { width: 100%; }
    .co-name { font-size: 16px; font-weight: bold; color: #00F5FF; letter-spacing: 1px; }
    .co-info { font-size: 7.5px; color: #8bd7e6; line-height: 1.6; margin-top: 1mm; }
    .doc-type { font-size: 21px; font-weight: bold; color: #00F5FF; text-transform: uppercase; text-align: right; letter-spacing: 2px; }
    .doc-num  { font-size: 8.5px; color: #7fd0e0; text-align: right; margin-top: 1mm; }
    #footer { position: fixed; bottom: -18mm; left: -13mm; right: -13mm; height: 16mm;
        border-top: 2px solid {{ $accent }}; padding: 2mm 13mm 0; font-size: 7px; color: #8892a6; }
    #footer table { width: 100%; }
    .ft-brand { color: {{ $primary }}; font-weight: bold; }
    #watermark { position: fixed; top: 62mm; left: 28mm; font-size: 52px; font-weight: bold;
        color: rgba(0,245,255,.12); transform: rotate(-35deg); white-space: nowrap; }
    .neon-rule { height: 4px; background: {{ $accent }}; margin-bottom: 4mm; box-shadow: 0 0 6px {{ $accent }}; }
    .addr-table { width: 100%; margin-bottom: 4mm; }
    .info-card { background: #0D0D1A; color: #e6f9ff; border-left: 3px solid {{ $accent }}; padding: 3mm 4mm; }
    .info-card .meta-value { color: #00F5FF; }
    .client-card { background: #f3fdff; border-left: 3px solid {{ $accent }}; padding: 3mm 4mm; }
    .sect-label { font-size: 7px; font-weight: bold; text-transform: uppercase;
        letter-spacing: 1px; padding-bottom: 1mm; margin-bottom: 2mm; }
    .info-card .sect-label { color: #00F5FF; border-bottom: 1px solid #24405a; }
    .client-card .sect-label { color: #0a7c8c; border-bottom: 1px solid #bdeef4; }
    .client-name { font-size: 11px; font-weight: bold; color: #0a2a33; margin-bottom: 1mm; }
    .client-detail { font-size: 8px; color: #4a5a6a; line-height: 1.6; }
    .meta-label { color: #7f93a6; font-size: 8px; } .meta-value { font-weight: bold; font-size: 8.5px; }
    .lines-table { width: 100%; border-collapse: collapse; margin-bottom: 4mm; }
    .lines-table thead tr { background: #0D0D1A; color: #00F5FF; }
    .lines-table thead th { padding: 2.2mm 2mm; font-size: 7.5px; text-align: left; text-transform: uppercase; letter-spacing: 1px; }
    .lines-table thead th.r { text-align: right; }
    .lines-table tbody tr.even { background: #f3fdff; }
    .lines-table tbody td { padding: 2mm; font-size: 8px; border-bottom: 1px solid #d7eff4; vertical-align: top; }
    ...
    .row-total td { font-size: 12px; color: #00F5FF; background: #0D0D1A;
        border-top: 2px solid {{ $accent }}; padding: 2mm; }
    .row-due td { color: #d11; font-size: 10px; }
    ...
    .bottom-qr img { width: 24mm; height: 24mm; } .qr-lbl { font-size: 6px; color: #7f93a6; text-align: center; margin-top: 1mm; }
    .bottom-totals { display: table-cell; vertical-align: top; }
    .notes-box { font-size: 8px; color: #4a5a6a; margin-bottom: 3mm; border-top: 1px solid #d7eff4; padding-top: 2mm; }
    .notes-title { font-weight: bold; color: #0a7c8c; margin-bottom: 1mm; }
    .sig-row { display: table; width: 100%; margin-top: 6mm; }
    .sig-col { display: table-cell; width: 50%; padding: 0 4mm; }
    .sig-line { border-bottom: 1px solid #0a7c8c; height: 8mm; margin-bottom: 1.5mm; }
    .sig-meta { font-size: 7px; color: #4a5a6a; line-height: 1.7; }
</style>
</head>
<body>
...
<div class="sig-row">
    <div class="sig-col"><div class="sect-label" style="color:#0a7c8c;">Émetteur</div><div class="sig-line"></div><div class="sig-meta">Nom : _______________<br/>Date : _______________</div></div>
    <div class="sig-col"><div class="sect-label" style="color:#0a7c8c;">Client</div><div class="sig-line"></div><div class="sig-meta">Nom : _______________<br/>Date : _______________</div></div>
</div>

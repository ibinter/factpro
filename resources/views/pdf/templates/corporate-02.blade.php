...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #263238; margin: 0; }
    ...
    /* En-tête acier : barre latérale gauche + traverse */
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px; border-bottom: 3px solid #37474F; }
    .head-bar { border-left: 6px solid #607D8B; padding-left: 10px; }
    .company-name { font-size: 18px; font-weight: bold; color: #37474F; letter-spacing: 1px; text-transform: uppercase; }
    .company-meta { font-size: 8.5px; color: #78909C; line-height: 1.5; }
    .doc-title { font-size: 19px; font-weight: bold; color: #607D8B; text-align: right; text-transform: uppercase; letter-spacing: 2px; }
    .doc-number { font-size: 11px; color: #78909C; text-align: right; }

    /* Pied de page */
    footer {
        position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #78909C; border-top: 2px solid #B0BEC5; padding-top: 6px;
    }

    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #ECEFF1; border-left: 3px solid #37474F; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #78909C; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #37474F; margin: 3px 0; }

    .meta-table { margin-top: 8px; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #78909C; }

    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th {
        background: #37474F; color: #ffffff; padding: 7px 8px; font-size: 9px;
        text-transform: uppercase; letter-spacing: 0.5px; text-align: left;
        border-bottom: 2px solid #B0BEC5;
    }
    table.lines thead th.num, table.lines td.num { text-align: right; }
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #CFD8DC; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #F5F7F8; }
    ...
    table.totals tr.grand td { background: #455A64; color: #ffffff; font-size: 12px; font-weight: bold; border-top: 2px solid #B0BEC5; }
    ...
    .notes .title { font-weight: bold; color: #37474F; margin-bottom: 3px; font-size: 9px; }
    .hash { font-size: 6.5px; color: #90A4AE; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">
                Propulsé par <b style="color:#607D8B">IBIG FactPro</b><br>

...
<style>
    @page { margin: 112px 50px 90px 50px; }
    ...
    * { box-sizing: border-box; }
    ...
    /* En-tête gastronome : maison centrée façon carte de restaurant, filets or */
    header { position: fixed; top: -84px; left: 0; right: 0; height: 76px; text-align: center; }
    .company-name { font-family: DejaVu Serif, serif; font-size: 19px; font-weight: bold; color: #1A1A1A; letter-spacing: 3px; }
    .company-meta { font-size: 7.5px; color: #8A8060; line-height: 1.6; letter-spacing: 0.5px; margin-top: 2px; }
    .gold-rule { border-bottom: 1px solid #B8860B; width: 34%; margin: 6px auto 0 auto; }
    .doc-title { font-family: DejaVu Serif, serif; font-size: 14px; font-weight: bold; color: #B8860B; letter-spacing: 5px; text-transform: uppercase; margin-top: 6px; }
    .doc-number { font-size: 9px; color: #8A8060; letter-spacing: 2px; }

    /* Pied de page */
    footer {
        position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #8A8060; border-top: 1px solid #B8860B; padding-top: 6px;
    }

    .addresses { width: 100%; margin-bottom: 20px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #F5EFD9; border: 1px solid #B8860B; padding: 10px 12px; }
    .badge-box .label { font-size: 7.5px; text-transform: uppercase; color: #B8860B; letter-spacing: 3px; }
    .badge-box .name { font-family: DejaVu Serif, serif; font-size: 12px; font-weight: bold; color: #1A1A1A; margin: 4px 0; }
    .badge-box .company-meta { text-align: left; color: #6E6A50; }

    .meta-table { margin-top: 8px; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #B8860B; text-transform: uppercase; font-size: 7.5px; letter-spacing: 1.5px; }

    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th {
        background: #1A1A1A; color: #E8C766; padding: 8px 8px; font-size: 8.5px;
    ...
    table.lines tbody td { padding: 8px 8px; border-bottom: 1px dotted #C9B77E; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #FBF8EE; }
    ...
    table.totals .k { color: #8A8060; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td {
        background: #1A1A1A; color: #E8C766; font-size: 12px; font-weight: bold;
        font-family: DejaVu Serif, serif; letter-spacing: 1px;
    }
    ...
    .qr-caption { font-size: 7px; color: #8A8060; margin-top: 2px; }
    .notes { font-size: 9px; color: #3A3A3A; padding-right: 20px; }
    .notes .title { font-family: DejaVu Serif, serif; font-weight: bold; color: #B8860B; margin-bottom: 3px; font-size: 9px; letter-spacing: 1px; }
    .hash { font-size: 6.5px; color: #B8AE8A; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">
                Propulsé par <b style="color:#B8860B">IBIG FactPro</b><br>

...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #1E3A5F; background: #FFFFFF; margin: 0; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(6,182,212,0.12); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #1E3A5F; color: #fff; padding: 8px 12px; }
    .company-name { font-size: 16px; font-weight: bold; color: #06B6D4; }
    .company-meta { font-size: 8px; color: #93C5FD; line-height: 1.5; }
    .doc-title { font-size: 17px; font-weight: bold; color: #06B6D4; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 9px; color: #BAE6FD; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #64748B; border-top: 3px solid #06B6D4; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #F0FDFE; border-left: 4px solid #06B6D4; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #0891B2; letter-spacing: 1px; }
    ...
    table.lines thead th { background: #1E3A5F; color: #06B6D4; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #E2E8F0; font-size: 9.5px; background: #FFFFFF; }
    table.lines tbody tr:nth-child(even) td { background: #F0FDFE; }
    ...
    table.totals tr.grand td { background: #1E3A5F; color: #06B6D4; font-size: 12px; font-weight: bold; }
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#06B6D4">IBIG FactPro</b></td>
        </tr>
    </table>
</footer>
<main>

...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .company-name { font-size: 18px; font-weight: bold; color: #1E3A5F; letter-spacing: 1px; }
    .company-meta { font-size: 8.5px; color: #6B7280; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #1E3A5F; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 11px; color: #9CA3AF; text-align: right; }
    .sector-badge { background: #1E3A5F; color: #9CA3AF; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #F8FAFC; border-left: 4px solid #1E3A5F; padding: 10px 12px; }
    ...
    table.lines thead th { background: #1E3A5F; color: #9CA3AF; padding: 7px 8px; font-size: 9px;
    ...
    table.totals tr.grand td { background: #1E3A5F; color: #9CA3AF; font-size: 12px; font-weight: bold; }
    ...
    .notes .title { font-weight: bold; color: #1E3A5F; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">Concessionnaire Automobile</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Vente de véhicules neufs et d\'occasion — Garantie constructeur.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#1E3A5F">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Contrat / VIN :</td><td>{{ $document->reference }}</td></tr>@endif
    ...
    <table class="lines">
        <thead><tr>
            <th style="width:42%">Désignation / Véhicule</th>

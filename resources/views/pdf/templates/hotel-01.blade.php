...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #0A0A0A; margin: 0; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #555; border-top: 2px solid #C9A227; padding-top: 6px; }
    .company-name { font-size: 18px; font-weight: bold; color: #0A0A0A; letter-spacing: 2px; }
    .company-meta { font-size: 8.5px; color: #555; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #C9A227; text-align: right; text-transform: uppercase; letter-spacing: 2px; }
    .doc-number { font-size: 11px; color: #555; text-align: right; }
    .gold-line { border-bottom: 1px solid #C9A227; margin: 4px 0; }
    .sector-badge { background: #C9A227; color: #0A0A0A; font-size: 8px; padding: 2px 8px;
        text-transform: uppercase; letter-spacing: 2px; display: inline-block; margin-top: 3px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #FAFAFA; border-left: 3px solid #C9A227; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #C9A227; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #0A0A0A; margin: 3px 0; }
    .meta-table { margin-top: 8px; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #888; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #0A0A0A; color: #C9A227; padding: 7px 8px; font-size: 9px;
        text-transform: uppercase; letter-spacing: 1px; text-align: left; }
    table.lines thead th.num, table.lines td.num { text-align: right; }
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #e5e5e5; font-size: 9.5px; }
    ...
    table.totals .k { color: #888; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #0A0A0A; color: #C9A227; font-size: 12px; font-weight: bold; }
    ...
    .qr-caption { font-size: 7px; color: #888; margin-top: 2px; }
    .notes { font-size: 9px; color: #444; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #C9A227; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">&#9733; Hôtel Luxe</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Nous vous remercions de votre séjour.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#C9A227">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">Réf. Réservation :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                <div class="label">Client / Hôte</div>
                @if ($document->customer)

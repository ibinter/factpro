...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #1A2E1A; margin: 0; }
    ...
    .company-meta { font-size: 8px; color: #B7E4C7; line-height: 1.5; }
    .doc-title { font-size: 18px; font-weight: bold; color: #fff; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 10px; color: #D4AF37; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #555; border-top: 3px solid #D4AF37; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #F0FDF4; border-left: 4px solid #1B4332; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #1B4332; letter-spacing: 1px; }
    ...
    .meta-table .k { color: #1B4332; font-weight: bold; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #1B4332; color: #D4AF37; padding: 7px 8px;
    ...
    table.totals .k { color: #1B4332; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #1B4332; color: #D4AF37; font-size: 12px; font-weight: bold; }
    ...
    .notes .title { font-weight: bold; color: #1B4332; margin-bottom: 3px; }
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#1B4332">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>

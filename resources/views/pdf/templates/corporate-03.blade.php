...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #2D3748; color: #fff; padding: 8px 12px; }
    .company-name { font-size: 16px; font-weight: bold; color: #38B2AC; }
    .company-meta { font-size: 8px; color: #CBD5E0; line-height: 1.5; }
    .doc-title { font-size: 18px; font-weight: bold; color: #38B2AC; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 10px; color: #CBD5E0; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #718096; border-top: 3px solid #38B2AC; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #EDF2F7; border-left: 4px solid #38B2AC; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #718096; letter-spacing: 1px; }
    ...
    .meta-table .k { color: #718096; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #2D3748; color: #38B2AC; padding: 7px 8px;
    ...
    table.totals .k { color: #718096; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #2D3748; color: #38B2AC; font-size: 12px; font-weight: bold; }
    table.totals tr.paid td { color: #38A169; }
    table.totals tr.due td { color: #E53E3E; }
    ...
    .qr-caption { font-size: 7px; color: #718096; margin-top: 2px; }
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#38B2AC">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            ...
            <td>
                    ...
                    @if ($document->customer)
                        ...
                        <div class="company-meta" style="color:#4A5568">

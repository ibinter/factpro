...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #134E4A; margin: 0; background: #fff; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(13,148,136,0.15); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #0D9488; padding: 8px 12px; }
    .company-name { font-size: 16px; font-weight: bold; color: #fff; }
    .company-meta { font-size: 8px; color: #CCFBF1; line-height: 1.5; }
    .doc-title { font-size: 18px; font-weight: bold; color: #fff; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 10px; color: #F59E0B; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B7280; border-top: 3px solid #F59E0B; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border-left: 4px solid #0D9488; padding: 10px 12px; background: #F0FDFA; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #0D9488; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #134E4A; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #0D9488; font-weight: bold; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #0D9488; color: #fff; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #CCFBF1; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #F0FDFA; }
    table.totals { width: 42%; margin-left: 58%; margin-top: 12px; border-collapse: collapse; }
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #CCFBF1; }
    table.totals .k { color: #6B7280; }
    table.totals .v { text-align: right; font-weight: bold; color: #134E4A; }
    table.totals tr.grand td { background: #0D9488; color: #fff; font-size: 12px; font-weight: bold; border: none; }
    ...
    .notes .title { font-weight: bold; color: #0D9488; margin-bottom: 3px; }
    .hash { font-size: 6.5px; color: #CCFBF1; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#0D9488">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>

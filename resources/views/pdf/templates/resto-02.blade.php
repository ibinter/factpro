...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Serif, serif; font-size: 10px; color: #3D1F00; margin: 0; background: #FEF9EC; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(139,26,26,0.15); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #8B1A1A; padding: 8px 12px; border-bottom: 3px solid #D4A017; }
    .company-name { font-size: 16px; font-weight: bold; color: #FEF9EC; letter-spacing: 1px; }
    .company-meta { font-size: 8px; color: #FECACA; line-height: 1.5; }
    .doc-title { font-size: 17px; font-weight: bold; color: #D4A017; text-align: right; text-transform: uppercase; letter-spacing: 2px; }
    .doc-number { font-size: 10px; color: #FEF9EC; text-align: right; font-style: italic; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B2D00; border-top: 2px solid #8B1A1A; padding-top: 6px;
        background: #FEF9EC; font-style: italic; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #D4A017; padding: 10px 12px; background: #FFF8E7; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #8B1A1A; letter-spacing: 1.5px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #3D1F00; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #8B1A1A; font-style: italic; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #8B1A1A; color: #FEF9EC; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #F5DDBF; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #FFF8E7; }
    table.totals { width: 42%; margin-left: 58%; margin-top: 12px; border-collapse: collapse; }
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #F5DDBF; }
    table.totals .k { color: #6B2D00; font-style: italic; }
    table.totals .v { text-align: right; font-weight: bold; color: #3D1F00; }
    table.totals tr.grand td { background: #8B1A1A; color: #D4A017; font-size: 12px; font-weight: bold; border: none; }
    ...
    .qr-caption { font-size: 7px; color: #9CA3AF; margin-top: 2px; font-style: italic; }
    .notes { font-size: 9px; color: #3D1F00; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #8B1A1A; margin-bottom: 3px; }
    .hash { font-size: 6.5px; color: #D4B896; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#8B1A1A">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            ...
            <td>
                    ...
                    @if ($document->customer)
                        ...
                        <div style="font-size:8.5px; color:#6B2D00; line-height:1.5">

...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        ...
        color: rgba(234,179,8,0.2); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #EAB308; padding: 8px 12px; border-bottom: 3px solid #111; }
    .company-name { font-size: 16px; font-weight: bold; color: #111; }
    .company-meta { font-size: 8px; color: #3D3000; line-height: 1.5; }
    .doc-title { font-size: 18px; font-weight: bold; color: #111; text-align: right; text-transform: uppercase; letter-spacing: 2px; }
    .doc-number { font-size: 10px; color: #3D3000; text-align: right; }
    ...
    .badge-box { border: 2px solid #EAB308; border-left: 5px solid #111; padding: 10px 12px; background: #FFFDF0; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #111; letter-spacing: 1px; font-weight: bold; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #111; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #555; font-weight: bold; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #111; color: #EAB308; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #FEF9C3; font-size: 9.5px; }
    ...
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #FEF9C3; }
    table.totals .k { color: #555; }
    table.totals .v { text-align: right; font-weight: bold; color: #111; }
    table.totals tr.grand td { background: #EAB308; color: #111; font-size: 12px; font-weight: bold; border: none; }
    ...
    .notes .title { font-weight: bold; color: #111; margin-bottom: 3px; }
    .hash { font-size: 6.5px; color: #FEF9C3; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>

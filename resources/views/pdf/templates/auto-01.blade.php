...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .company-name { font-size: 18px; font-weight: bold; color: #4B5563; }
    ...
    .sector-badge { background: #4B5563; color: #fff; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #F9FAFB; border-left: 4px solid #DC2626; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #9CA3AF; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #4B5563; margin: 3px 0; }
    ...
    table.lines thead th { background: #4B5563; color: #fff; padding: 7px 8px; font-size: 9px;
    ...
    .notes .title { font-weight: bold; color: #4B5563; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">Garage Auto — Réparations</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Réparation automobile — Pièces et main-d\'œuvre garanties.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
...
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Ordre de réparation :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                <div class="label">Client / Propriétaire</div>
    ...
    <table class="lines">
        <thead><tr>
            <th style="width:42%">Désignation / Pièce</th>

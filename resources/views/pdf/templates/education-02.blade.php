...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .doc-title { font-size: 20px; font-weight: bold; color: #15803D; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 11px; color: #6B7280; text-align: right; }
    .sector-badge { background: #D97706; color: #fff; font-size: 8px; padding: 2px 8px;
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">&#128218; Formation Professionnelle</div>
            <div class="company-meta">
                ...
                @if($company->tax_id)<br>N° Déclaration d'activité : {{ $company->tax_id }}@endif
            </div>
        </td>
        <td style="width:45%">
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Formation professionnelle continue — CPF éligible.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
    ...
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Dossier formation :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                <div class="label">Stagiaire / Entreprise</div>
                @if ($document->customer)

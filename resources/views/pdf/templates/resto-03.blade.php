...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Serif, serif; font-size: 10px; color: #1A2E1A; margin: 0; background: #FAFAF5; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(20,83,45,0.15); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #14532D; padding: 8px 12px; border-bottom: 3px solid #CA8A04; }
    .company-name { font-size: 16px; font-weight: bold; color: #CA8A04; letter-spacing: 1px; }
    ...
    .doc-number { font-size: 10px; color: #CA8A04; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #555; border-top: 2px solid #CA8A04; padding-top: 6px;
        background: #FAFAF5; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #CA8A04; border-left: 3px solid #14532D; padding: 10px 12px; background: #F7FAF2; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #14532D; letter-spacing: 1.5px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #1A2E1A; margin: 3px 0; }
    ...
    table.lines thead th { background: #14532D; color: #CA8A04; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #D9F2DC; font-size: 9.5px; }
    ...
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #D9F2DC; }
    table.totals .k { color: #14532D; }
    table.totals .v { text-align: right; font-weight: bold; color: #1A2E1A; }
    table.totals tr.grand td { background: #14532D; color: #CA8A04; font-size: 12px; font-weight: bold; border: none; }
    ...
    .hash { font-size: 6.5px; color: #BBF7D0; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#14532D">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            ...
            <td>
                    ...
                    @if ($document->customer)
                        ...
                        <div style="font-size:8.5px; color:#555; line-height:1.5">

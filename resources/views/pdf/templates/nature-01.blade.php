...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #33402F; margin: 0; background-color: #FAF6EF; }

    /* Fond crème kraft pleine page */
    .paper-bg { position: fixed; top: -100px; left: -45px; right: -45px; bottom: -90px; background: #FAF6EF; z-index: -10; }
    ...
    /* En-tête nature : filet feuille + verts végétaux */
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px; border-bottom: 2px solid #81C784; }
    .company-name { font-size: 18px; font-weight: bold; color: #2E7D32; }
    .company-meta { font-size: 8.5px; color: #7D8B6F; line-height: 1.5; }
    .doc-title { font-size: 19px; font-weight: bold; color: #558B2F; text-align: right; text-transform: uppercase; letter-spacing: 1px; }
    .doc-number { font-size: 11px; color: #7D8B6F; text-align: right; }

    /* Pied de page */
    footer {
        position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #7D8B6F; border-top: 2px solid #81C784; padding-top: 6px;
    }

    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #EEF4E4; border-left: 4px solid #2E7D32; padding: 10px 12px; border-radius: 4px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #558B2F; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #2E7D32; margin: 3px 0; }

    .meta-table { margin-top: 8px; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #558B2F; }

    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th {
        background: #2E7D32; color: #F5FBEF; padding: 7px 8px; font-size: 9px;
        text-transform: uppercase; letter-spacing: 0.5px; text-align: left;
    }
    table.lines thead th.num, table.lines td.num { text-align: right; }
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #DCE5CD; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #F2F0E4; }
    ...
    table.totals .k { color: #7D8B6F; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #2E7D32; color: #F5FBEF; font-size: 12px; font-weight: bold; }
    ...
    .qr-caption { font-size: 7px; color: #7D8B6F; margin-top: 2px; }
    .notes { font-size: 9px; color: #4E5B41; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #2E7D32; margin-bottom: 3px; font-size: 9px; }
    .hash { font-size: 6.5px; color: #A3AD8F; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">
                Propulsé par <b style="color:#2E7D32">IBIG FactPro</b><br>

...
<style>
    @@page { margin: 105px 45px 90px 45px; }

    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #4E342E; margin: 0; }
    ...
    /* En-tête atelier : cartouche bois, titres serif chaleureux */
    header { position: fixed; top: -78px; left: 0; right: 0; height: 70px; }
    .wood-band { background: #6D4C41; border-bottom: 3px solid #D7A86E; padding: 10px 14px; }
    .company-name { font-family: DejaVu Serif, serif; font-size: 17px; font-weight: bold; color: #F9F1E7; }
    .company-meta { font-size: 8px; color: #E4CDB3; line-height: 1.5; }
    .doc-title { font-family: DejaVu Serif, serif; font-size: 18px; font-weight: bold; color: #D7A86E; text-align: right; text-transform: uppercase; letter-spacing: 1.5px; }
    .doc-number { font-size: 10px; color: #E4CDB3; text-align: right; }

    /* Pied de page */
    footer {
        position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #8D6E63; border-top: 2px solid #D7A86E; padding-top: 6px;
    }

    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #F3E5D8; border-left: 4px solid #6D4C41; padding: 10px 12px; border-radius: 3px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #8D6E63; letter-spacing: 1px; }
    .badge-box .name { font-family: DejaVu Serif, serif; font-size: 12px; font-weight: bold; color: #5D4037; margin: 3px 0; }
    .badge-box .company-meta { color: #8D6E63; }

    .meta-table { margin-top: 8px; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #A1887F; }

    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th {
        background: #6D4C41; color: #F9F1E7; padding: 7px 8px; font-size: 9px;
        text-transform: uppercase; letter-spacing: 0.5px; text-align: left;
        border-bottom: 2px solid #D7A86E;
    }
    table.lines thead th.num, table.lines td.num { text-align: right; }
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #E8D9C8; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #FAF3EA; }
    ...
    table.totals .k { color: #8D6E63; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #6D4C41; color: #F9F1E7; font-size: 12px; font-weight: bold; border-bottom: 2px solid #D7A86E; }
    table.totals tr.paid td { color: #33691E; }
    table.totals tr.due td { color: #BF360C; }
    ...
    .qr-caption { font-size: 7px; color: #8D6E63; margin-top: 2px; }
    .notes { font-size: 9px; color: #5D4037; padding-right: 20px; }
    .notes .title { font-family: DejaVu Serif, serif; font-weight: bold; color: #6D4C41; margin-bottom: 3px; font-size: 9px; }
    .hash { font-size: 6.5px; color: #BCAAA4; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">
                Propulsé par <b style="color:#6D4C41">IBIG FactPro</b><br>

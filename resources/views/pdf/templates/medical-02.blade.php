...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B7280; border-top: 3px solid #16A34A; padding-top: 6px; }
    ...
    .cross { color: #16A34A; font-size: 22px; font-weight: bold; vertical-align: middle; }
    .sector-badge { background: #16A34A; color: #fff; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #F0FDF4; border-left: 4px solid #16A34A; padding: 10px 12px; }
    ...
    table.lines thead th { background: #16A34A; color: #fff; padding: 7px 8px; font-size: 9px;
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            <div class="company-name"><span class="cross">+</span> {{ $company->name }}</div>
            <div class="sector-badge">Pharmacie</div>
            <div class="company-meta">
                ...
                @if($company->tax_id)<br>N° Licence : {{ $company->tax_id }}@endif
            </div>
        </td>
        <td style="width:45%">
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Votre santé, notre priorité.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#16A34A">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Ordonnance :</td><td>{{ $document->reference }}</td></tr>@endif

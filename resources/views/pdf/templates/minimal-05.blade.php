...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #374151; margin: 0; background: #fff; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(67,56,202,0.12); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #374151; padding: 8px 12px; }
    .company-name { font-size: 15px; font-weight: bold; color: #fff; }
    .company-meta { font-size: 8px; color: #9CA3AF; line-height: 1.5; }
    .doc-title { font-size: 18px; font-weight: bold; color: #4338CA; text-align: right; text-transform: uppercase; letter-spacing: 2px; }
    .doc-number { font-size: 10px; color: #9CA3AF; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B7280; border-top: 2px solid #4338CA; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border-left: 4px solid #4338CA; padding: 10px 12px; background: #EEF2FF; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #4338CA; letter-spacing: 1.5px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #1F2937; margin: 3px 0; }
    ...
    table.lines thead th { background: #374151; color: #E5E7EB; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #F3F4F6; font-size: 9.5px; }
    ...
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #F3F4F6; }
    table.totals .k { color: #6B7280; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #4338CA; color: #fff; font-size: 12px; font-weight: bold; border: none; }
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#4338CA">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>

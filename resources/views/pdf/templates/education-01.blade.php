...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B7280; border-top: 3px solid #B45309; padding-top: 6px; }
    .company-name { font-size: 18px; font-weight: bold; color: #1D4ED8; }
    .company-meta { font-size: 8.5px; color: #6B7280; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #1D4ED8; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 11px; color: #6B7280; text-align: right; }
    .sector-badge { background: #B45309; color: #fff; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #EFF6FF; border-left: 4px solid #1D4ED8; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #9CA3AF; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #1D4ED8; margin: 3px 0; }
    ...
    table.lines thead th { background: #1D4ED8; color: #fff; padding: 7px 8px; font-size: 9px;
    ...
    table.totals tr.grand td { background: #1D4ED8; color: #fff; font-size: 12px; font-weight: bold; }
    ...
    .notes .title { font-weight: bold; color: #1D4ED8; margin-bottom: 3px; font-size: 9px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">&#9998; École Privée</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Frais scolaires — Année académique en cours.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#1D4ED8">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">Année académique :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                <div class="label">Famille / Élève</div>
                @if ($document->customer)

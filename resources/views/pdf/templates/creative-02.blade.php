...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #1F0635; margin: 0; background: #fff; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(236,72,153,0.12); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #EC4899; padding: 8px 12px; }
    .company-name { font-size: 16px; font-weight: bold; color: #fff; }
    .company-meta { font-size: 8px; color: #FCE7F3; line-height: 1.5; }
    .doc-title { font-size: 18px; font-weight: bold; color: #fff; text-align: right; text-transform: uppercase; letter-spacing: 2px; }
    .doc-number { font-size: 10px; color: #FCE7F3; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B7280; border-top: 3px solid #8B5CF6; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border-left: 4px solid #EC4899; padding: 10px 12px; background: #FDF2F8; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #EC4899; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #1F0635; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #8B5CF6; font-weight: bold; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #8B5CF6; color: #fff; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #F3E8FF; font-size: 9.5px; }
    ...
    table.totals .v { text-align: right; font-weight: bold; color: #1F0635; }
    table.totals tr.grand td { background: #EC4899; color: #fff; font-size: 12px; font-weight: bold; }
    ...
    .notes { font-size: 9px; color: #4B5563; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #8B5CF6; margin-bottom: 3px; }
    .hash { font-size: 6.5px; color: #E9D5FF; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#EC4899">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>

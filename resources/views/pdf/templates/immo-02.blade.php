...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #111827; margin: 0; background: #fff; }
    ...
    header { position: fixed; top: -75px; left: 0; right: 0; height: 65px;
        background: #374151; padding: 8px 14px; border-left: 6px solid #EA580C; }
    .company-name { font-size: 17px; font-weight: bold; color: #fff; }
    .company-meta { font-size: 8px; color: #9CA3AF; line-height: 1.5; }
    .doc-title { font-size: 15px; font-weight: bold; color: #EA580C; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 10px; color: #D1D5DB; text-align: right; }
    .promo-tag { font-size: 7.5px; color: #F9FAFB; text-align: right; text-transform: uppercase; letter-spacing: 1px; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #374151; border-top: 3px solid #EA580C; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #D1D5DB; border-left: 5px solid #EA580C; padding: 10px 12px; background: #F9FAFB; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #374151; letter-spacing: 1px; font-weight: bold; }
    ...
    table.lines thead th { background: #374151; color: #fff; padding: 7px 8px;
        font-size: 9px; text-transform: uppercase; letter-spacing: 0.5px; text-align: left; border-bottom: 2px solid #EA580C; }
    ...
    table.totals .k { color: #374151; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #EA580C; color: #fff; font-size: 12px; font-weight: bold; border: none; }
    ...
    .notes { font-size: 9px; color: #111827; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #EA580C; margin-bottom: 3px; }
        ...
        <tr>
            <td style="width:55%">
                ...
                <div class="company-meta">
                    ...
                    @if($company->tax_id)<br>N° RC : {{ $company->tax_id }}@endif
                </div>
            </td>
            <td style="width:45%">
                <div class="promo-tag">Promotion Immobilière &amp; BTP</div>
...
<footer>
    <table style="width:100%">
        <tr>
            <td style="width:70%">{{ $company->invoice_footer ?? 'Promoteur immobilier agréé — Bâtisseurs de votre futur.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
            <td style="width:30%; text-align:right; color:#374151;">Propulsé par <b>IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
    ...
    <table class="lines">
        <thead>
            <tr>
                <th style="width:42%">Désignation / Travaux</th>

...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #2D3748; margin: 0; background: #F7FAFC; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(200,200,200,0.35); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #F7FAFC; padding: 8px 12px; border-bottom: 1px solid #CBD5E0; }
    .company-name { font-size: 15px; font-weight: bold; color: #2D3748; }
    .company-meta { font-size: 8px; color: #718096; line-height: 1.5; }
    .doc-title { font-size: 17px; font-weight: bold; color: #2D3748; text-align: right; text-transform: uppercase; letter-spacing: 3px; }
    .doc-number { font-size: 10px; color: #A0AEC0; text-align: right; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #A0AEC0; border-top: 1px solid #CBD5E0; padding-top: 6px;
        background: #F7FAFC; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #CBD5E0; padding: 10px 12px; background: #fff; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #A0AEC0; letter-spacing: 1.5px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #2D3748; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #A0AEC0; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #EDF2F7; color: #4A5568; padding: 7px 8px;
    ...
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #EDF2F7; font-size: 9.5px; background: #fff; }
    table.lines tbody tr:nth-child(even) td { background: #F7FAFC; }
    table.totals { width: 42%; margin-left: 58%; margin-top: 12px; border-collapse: collapse; }
    table.totals td { padding: 5px 8px; font-size: 10px; border-bottom: 1px solid #EDF2F7; }
    table.totals .k { color: #A0AEC0; }
    table.totals .v { text-align: right; font-weight: bold; color: #2D3748; }
    table.totals tr.grand td { background: #2D3748; color: #F7FAFC; font-size: 12px; font-weight: bold; border: none; }
    table.totals tr.paid td { color: #38A169; border-bottom: none; }
    table.totals tr.due td { color: #E53E3E; border-bottom: none; }
    ...
    .qr-caption { font-size: 7px; color: #A0AEC0; margin-top: 2px; }
    .notes { font-size: 9px; color: #4A5568; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #2D3748; margin-bottom: 3px; }
    .hash { font-size: 6.5px; color: #CBD5E0; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#4A5568">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
            ...
            <td>
                @if ($document->customer)
                    <div class="badge-box">
                        ...
                        <div style="font-size:8.5px; color:#718096; line-height:1.5">

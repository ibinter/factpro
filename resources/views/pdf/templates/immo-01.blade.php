...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    header { position: fixed; top: -80px; left: 0; right: 0; height: 70px;
        background: #1E40AF; padding: 0; }
    .header-top { background: #F59E0B; height: 5px; }
    .header-inner { padding: 6px 14px; }
    .company-name { font-size: 17px; font-weight: bold; color: #fff; }
    .company-meta { font-size: 8px; color: #BFDBFE; line-height: 1.5; }
    .doc-title { font-size: 15px; font-weight: bold; color: #FCD34D; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 10px; color: #fff; text-align: right; }
    .agence-tag { font-size: 7.5px; color: #93C5FD; text-align: right; text-transform: uppercase; letter-spacing: 1px; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #1E40AF; border-top: 3px solid #F59E0B; padding-top: 6px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 2px solid #1E40AF; border-top: 4px solid #F59E0B; padding: 10px 12px; background: #EFF6FF; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #1E40AF; letter-spacing: 1px; }
    ...
    .meta-table .k { color: #1E40AF; font-weight: bold; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #1E40AF; color: #FCD34D; padding: 7px 8px;
    ...
    table.totals .k { color: #1E40AF; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #1E40AF; color: #FCD34D; font-size: 12px; font-weight: bold; border: none; }
    ...
    .notes .title { font-weight: bold; color: #1E40AF; margin-bottom: 3px; }
    ...
    <div class="header-inner">
        <table style="width:100%">
            <tr>
                ...
                <td style="width:45%">
                    <div class="agence-tag">Agence Immobilière Prestige</div>
...
<footer>
    <table style="width:100%">
        <tr>
            <td style="width:70%">{{ $company->invoice_footer ?? 'Votre partenaire immobilier de confiance.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
            <td style="width:30%; text-align:right; color:#1E40AF;">Propulsé par <b>IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            <td>
                <table class="meta-table">
                    ...
                    @if ($document->reference)<tr><td class="k">Réf. bien :</td><td>{{ $document->reference }}</td></tr>@endif
                    <tr><td class="k">Devise :</td><td>{{ $document->currency }}</td></tr>
                </table>
            </td>
            <td>
                    <div class="badge-box">
                        <div class="label">Acquéreur / Client</div>
    ...
    <table class="lines">
        <thead>
            <tr>
                <th style="width:42%">Désignation / Bien</th>

...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #1A237E; margin: 0; }
    ...
    /* En-tête startup : indigo + pastille grid */
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px; border-bottom: 3px solid #3949AB; }
    .company-name { font-size: 18px; font-weight: bold; color: #3949AB; }
    .company-meta { font-size: 8.5px; color: #7986CB; line-height: 1.5; }
    .doc-title {
        font-size: 18px; font-weight: bold; color: #ffffff; background: #3949AB;
        text-align: center; text-transform: uppercase; letter-spacing: 2px;
        padding: 5px 10px; display: inline-block; float: right; border-radius: 3px;
    }
    .doc-number { font-size: 11px; color: #5C6BC0; text-align: right; clear: both; padding-top: 3px; }

    /* Pied de page */
    footer {
        position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #7986CB; border-top: 2px solid #5C6BC0; padding-top: 6px;
    }

    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #E8EAF6; border: 1px solid #C5CAE9; border-left: 4px solid #3949AB; padding: 10px 12px; border-radius: 4px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #5C6BC0; letter-spacing: 1px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #283593; margin: 3px 0; }

    .meta-table { border-collapse: collapse; margin-top: 8px; }
    .meta-table td { padding: 3px 8px; font-size: 9px; border: 1px solid #E8EAF6; }
    .meta-table .k { color: #5C6BC0; background: #F5F6FC; }

    /* Quadrillage léger : toutes les cellules finement bordées */
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th {
        background: #3949AB; color: #ffffff; padding: 7px 8px; font-size: 9px;
        text-transform: uppercase; letter-spacing: 0.5px; text-align: left;
        border: 1px solid #5C6BC0;
    }
    table.lines thead th.num, table.lines td.num { text-align: right; }
    table.lines tbody td { padding: 7px 8px; border: 1px solid #E8EAF6; font-size: 9.5px; }
    table.lines tbody tr:nth-child(even) td { background: #F7F8FD; }

    table.totals { width: 42%; margin-left: 58%; margin-top: 12px; border-collapse: collapse; }
    table.totals td { padding: 5px 8px; font-size: 10px; border: 1px solid #E8EAF6; }
    table.totals .k { color: #5C6BC0; }
    table.totals .v { text-align: right; font-weight: bold; }
    table.totals tr.grand td { background: #3949AB; color: #ffffff; font-size: 12px; font-weight: bold; border: 1px solid #3949AB; }
    ...
    .qr-caption { font-size: 7px; color: #7986CB; margin-top: 2px; }
    .notes { font-size: 9px; color: #283593; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #3949AB; margin-bottom: 3px; font-size: 9px; }
    .hash { font-size: 6.5px; color: #9FA8DA; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">
                Propulsé par <b style="color:#3949AB">IBIG FactPro</b><br>

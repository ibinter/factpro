...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #6B7280; border-top: 3px solid #EA580C; padding-top: 6px; }
    .company-name { font-size: 18px; font-weight: bold; color: #EA580C; }
    .company-meta { font-size: 8.5px; color: #6B7280; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #374151; text-align: right; text-transform: uppercase; }
    .doc-number { font-size: 11px; color: #6B7280; text-align: right; }
    .sector-badge { display: inline-block; background: #EA580C; color: #fff;
        font-size: 8px; padding: 2px 8px; letter-spacing: 1px; text-transform: uppercase; margin-top: 3px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #FFF7ED; border-left: 3px solid #EA580C; padding: 10px 12px; border-radius: 3px; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">&#9656; Transport Routier</div>

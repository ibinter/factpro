...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #3b2400; margin: 0; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #92400E; border-top: 2px solid #4D7C0F; padding-top: 6px; }
    ...
    .sector-badge { background: #4D7C0F; color: #FEF3C7; font-size: 8px; padding: 2px 8px;
    ...
    .badge-box { background: #FEF3C7; border-left: 4px solid #4D7C0F; padding: 10px 12px; }
    ...
    table.lines thead th { background: #4D7C0F; color: #FEF3C7; padding: 7px 8px; font-size: 9px;
    ...
    table.totals tr.grand td { background: #4D7C0F; color: #FEF3C7; font-size: 12px; font-weight: bold; }
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">&#127968; Auberge / Guest House</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Bienvenue et merci de votre séjour !' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
...
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Réservation :</td><td>{{ $document->reference }}</td></tr>@endif
    ...
    <table class="lines">
        <thead><tr>
            <th style="width:42%">Prestation / Séjour</th>

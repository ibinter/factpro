...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Serif, serif; font-size: 10px; color: #3B1F08; margin: 0; background: #FFFBF0; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(201,147,94,0.18); z-index: 1000; letter-spacing: 4px; }
    header { position: fixed; top: -70px; left: 0; right: 0; height: 60px;
        background: #FFFBF0; padding: 8px 12px;
        border-top: 3px solid #C9935E; border-bottom: 1px solid #E8D5B7; }
    .company-name { font-size: 16px; font-weight: bold; color: #3B1F08; letter-spacing: 1px; }
    .company-meta { font-size: 8px; color: #8B5E3C; line-height: 1.5; font-style: italic; }
    .doc-title { font-size: 17px; font-weight: bold; color: #C9935E; text-align: right; text-transform: uppercase; letter-spacing: 3px; }
    .doc-number { font-size: 10px; color: #8B5E3C; text-align: right; font-style: italic; }
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #8B5E3C; border-top: 1px solid #C9935E; padding-top: 6px;
        background: #FFFBF0; font-style: italic; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { border: 1px solid #C9935E; padding: 12px; background: #FFF8EF; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #C9935E; letter-spacing: 2px; }
    .badge-box .name { font-size: 12px; font-weight: bold; color: #3B1F08; margin: 3px 0; }
    .meta-table td { padding: 2px 8px 2px 0; font-size: 9px; }
    .meta-table .k { color: #8B5E3C; font-style: italic; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #3B1F08; color: #C9935E; padding: 8px 8px;
    ...
    table.lines tbody td { padding: 8px 8px; border-bottom: 1px solid #E8D5B7; font-size: 9.5px; }
    ...
    table.totals td { padding: 6px 8px; font-size: 10px; border-bottom: 1px solid #E8D5B7; }
    table.totals .k { color: #8B5E3C; font-style: italic; }
    table.totals .v { text-align: right; font-weight: bold; color: #3B1F08; }
    table.totals tr.grand td { background: #3B1F08; color: #C9935E; font-size: 12px; font-weight: bold; border: none; }
    ...
    .qr-caption { font-size: 7px; color: #8B5E3C; margin-top: 2px; font-style: italic; }
    .notes { font-size: 9px; color: #3B1F08; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #C9935E; margin-bottom: 3px; }
    .hash { font-size: 6.5px; color: #C9B89A; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<footer>
    <table style="width:100%">
        <tr>
            ...
            <td style="width:30%; text-align:right;">Propulsé par <b style="color:#C9935E">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
        </tr>
    </table>
</footer>
<main>
        ...
        <tr>
            ...
            <td>
                    ...
                    @if ($document->customer)
                        ...
                        <div style="font-size:8.5px; color:#8B5E3C; line-height:1.5; font-style:italic">

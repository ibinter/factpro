...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: DejaVu Sans, sans-serif; font-size: 10px; color: #e2e8f0; margin: 0; background: #111; }
    .watermark { position: fixed; top: 40%; left: 5%; width: 90%; text-align: center;
        transform: rotate(-35deg); font-size: 42px; font-weight: bold;
        color: rgba(6,182,212,0.15); z-index: 1000; letter-spacing: 4px; }
    ...
    footer { position: fixed; bottom: -70px; left: 0; right: 0; height: 60px;
        font-size: 8px; color: #94a3b8; border-top: 2px solid #7C3AED; padding-top: 6px; background: #111; }
    .company-name { font-size: 18px; font-weight: bold; color: #7C3AED; }
    .company-meta { font-size: 8.5px; color: #94a3b8; line-height: 1.5; }
    .doc-title { font-size: 20px; font-weight: bold; color: #06B6D4; text-align: right; text-transform: uppercase; letter-spacing: 1px; }
    .doc-number { font-size: 11px; color: #94a3b8; text-align: right; }
    .sector-badge { background: #7C3AED; color: #fff; font-size: 8px; padding: 2px 8px;
        text-transform: uppercase; letter-spacing: 1px; display: inline-block; margin-top: 3px; }
    .addresses { width: 100%; margin-bottom: 18px; }
    .addresses td { vertical-align: top; width: 50%; }
    .badge-box { background: #1e1b4b; border-left: 3px solid #7C3AED; padding: 10px 12px; }
    .badge-box .label { font-size: 8px; text-transform: uppercase; color: #06B6D4; letter-spacing: 1px; }
    ...
    .meta-table .k { color: #94a3b8; }
    table.lines { width: 100%; border-collapse: collapse; margin-top: 10px; }
    table.lines thead th { background: #7C3AED; color: #fff; padding: 7px 8px; font-size: 9px;
        text-transform: uppercase; letter-spacing: 0.5px; text-align: left; }
    table.lines thead th.num, table.lines td.num { text-align: right; }
    table.lines tbody td { padding: 7px 8px; border-bottom: 1px solid #1e293b; font-size: 9.5px; color: #e2e8f0; }
    table.lines tbody tr:nth-child(even) td { background: #1e1b4b; }
    ...
    table.totals tr.grand td { background: #7C3AED; color: #fff; font-size: 12px; font-weight: bold; }
    ...
    .qr-caption { font-size: 7px; color: #94a3b8; margin-top: 2px; }
    .notes { font-size: 9px; color: #cbd5e1; padding-right: 20px; }
    .notes .title { font-weight: bold; color: #06B6D4; margin-bottom: 3px; font-size: 9px; }
    .hash { font-size: 6.5px; color: #475569; word-break: break-all; margin-top: 4px; }
</style>
</head>
<body>
...
<header>
    <table style="width:100%"><tr>
        <td style="width:55%">
            ...
            <div class="sector-badge">SaaS — Abonnement logiciel</div>
...
<footer>
    <table style="width:100%"><tr>
        <td style="width:70%">{{ $company->invoice_footer ?? 'Abonnements logiciel et licences — Support 24/7.' }}<br>Vérification : {{ $document->verificationUrl() }}</td>
        <td style="width:30%; text-align:right;">Propulsé par <b style="color:#7C3AED">IBIG FactPro</b><br>factpro.ibigsoft.com</td>
    </tr></table>
</footer>
<main>
    <table class="addresses"><tr>
        <td>
            <table class="meta-table">
                ...
                @if($document->reference)<tr><td class="k">N° Abonnement :</td><td>{{ $document->reference }}</td></tr>@endif
        ...
        <td>
            ...
            <div class="badge-box">
                <div class="label">Client / Subscriber</div>
    ...
    <table class="lines">
        <thead><tr>
            <th style="width:42%">Service / Licence</th>

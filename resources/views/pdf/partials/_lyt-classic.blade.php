...
<head>
    ...
    <style>
        ...
        * {
        ...
        table.lines-table tbody td.desc {
            color: #555555;
            font-size: 8px;
            font-style: italic;
        }
        ...
        <div class="col-doc-info">
            <div class="card">
                ...
                <div class="card-row">
                    ...
                    <span class="card-value">{{ $document->currency ?? 'XOF' }}</span>
                </div>
            </div>
        </div>
    ...
    <table class="lines-table">
        ...
        <tbody>
            ...
            <tr class="{{ $index % 2 === 0 ? 'row-even' : 'row-odd' }}">
                ...
                <td class="text-right">{{ number_format((float)($line->quantity ?? 1), 2) }}</td>

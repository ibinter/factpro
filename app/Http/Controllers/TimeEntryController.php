...
class TimeEntryController extends Controller
{
    ...
    public function store(Request $request, Project $project): RedirectResponse
    {
        ...
        return redirect()->route('projects.index')->with('success', 'Temps enregistré.');
    }
    ...
    public function update(Request $request, TimeEntry $entry): RedirectResponse
    {
        ...
        return redirect()->route('projects.index')->with('success', 'Entrée mise à jour.');
    }
    ...
    public function destroy(Request $request, TimeEntry $entry): RedirectResponse
    {
        ...
        return redirect()->route('projects.index')->with('success', 'Entrée supprimée.');
    }

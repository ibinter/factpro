...
class CouponAdminController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.coupons')->with('success', "Coupon « {$data['code']} » créé.");
    }
    ...
    public function update(Request $request, Coupon $coupon): RedirectResponse
    {
        ...
        return redirect()->route('admin.coupons')->with('success', "Coupon « {$coupon->code} » mis à jour.");
    }
    ...
    public function destroy(Coupon $coupon): RedirectResponse
    {
        ...
        return redirect()->route('admin.coupons')->with('success', 'Coupon supprimé.');
    }
    ...
    public function toggle(Coupon $coupon): RedirectResponse
    {
        ...
        return redirect()->route('admin.coupons')->with('success', $coupon->is_active ? 'Coupon activé.' : 'Coupon désactivé.');
    }

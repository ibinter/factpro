...
class LicenseAdminController extends Controller
{
    ...
    public function extend(Request $request, License $license): RedirectResponse
    {
        ...
        return redirect()->route('admin.licenses')->with('success', "Licence prolongée de {$data['months']} mois (fin : {$license->fresh()->ends_at->format('d/m/Y')}).");
    }
    ...
    public function suspend(Request $request, License $license): RedirectResponse
    {
        ...
        return redirect()->route('admin.licenses')->with('success', 'Licence suspendue.');
    }
    ...
    public function reactivate(Request $request, License $license): RedirectResponse
    {
        ...
        return redirect()->route('admin.licenses')->with('success', 'Licence réactivée.');
    }
    ...
    public function revoke(Request $request, License $license): RedirectResponse
    {
        ...
        return redirect()->route('admin.licenses')->with('success', 'Licence révoquée définitivement.');
    }
    ...
    public function confirmProvisional(Request $request, License $license): RedirectResponse
    {
        ...
        return redirect()->route('admin.licenses')->with('success', 'Licence provisoire convertie en licence active.');
    }

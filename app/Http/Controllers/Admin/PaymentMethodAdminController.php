...
class PaymentMethodAdminController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.methods')->with('success', "Moyen de paiement « {$method->label} » ajouté.");
    }
    ...
    public function update(Request $request, PaymentMethodConfig $method): RedirectResponse
    {
        ...
        return redirect()->route('admin.methods')->with('success', "Moyen de paiement « {$method->label} » mis à jour.");
    }
    ...
    public function destroy(Request $request, PaymentMethodConfig $method): RedirectResponse
    {
        ...
        return redirect()->route('admin.methods')->with('success', "Moyen de paiement « {$label} » supprimé.");
    }
    ...
    public function toggle(Request $request, PaymentMethodConfig $method): RedirectResponse
    {
        ...
        return redirect()->route('admin.methods')->with('success', $method->is_active
            ? "« {$method->label} » activé."

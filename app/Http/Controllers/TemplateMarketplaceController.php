...
class TemplateMarketplaceController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('templates.marketplace.index')->with('success', 'Template soumis. Il sera visible après modération.');
    }
    ...
    public function update(TemplateMarketplace $template, Request $request): RedirectResponse
    {
        ...
        return redirect()->route('templates.marketplace.index')->with('success', 'Template mis à jour.');
    }
    ...
    public function destroy(TemplateMarketplace $template, Request $request): RedirectResponse
    {
        ...
        return redirect()->route('templates.marketplace.index')->with('success', 'Template supprimé.');
    }
    ...
    public function rate(TemplateMarketplace $template, Request $request): RedirectResponse
    {
        ...
        return redirect()->route('templates.marketplace.index')->with('success', 'Note enregistrée.');
    }
    ...
    public function approve(TemplateMarketplace $template, Request $request): RedirectResponse
    {
        ...
        return redirect()->route('templates.marketplace.index')->with('success', 'Template approuvé.');
    }
